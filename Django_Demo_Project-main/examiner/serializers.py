...
class ExamSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Exam
        fields = ['id','title','description', 'passing_percent_mark', 'exam_link','start_time','end_time','is_time_limit', 'allow_redo_exam','is_date_limit','time_limit_hour','time_limit_minute','total_question','questions','created_by','is_active', 'is_deleted']
...
class ExamCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Exam
        fields = ['id','title','description', 'passing_percent_mark', 'exam_link','start_time','end_time','is_time_limit', 'allow_redo_exam','is_date_limit','time_limit_hour','time_limit_minute','total_question','questions','created_by','is_active']
