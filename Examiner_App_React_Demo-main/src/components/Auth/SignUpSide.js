...
const SignUpSide = () => {
  ...
  const formSubmitHandler = async(event) =>{
    ...
    if(enteredEmail.length > 0 && enteredName.length > 0  && enteredPassword.length > 0  && enteredPassword2.length > 0 ){
          ...
          >
            ...
            <Box component="form" noValidate onSubmit={formSubmitHandler} sx={{ mt: 1 }}>
              ...
              <Grid container>
                ...
                <Grid item>
                  <NavLink to='/auth/login' style={{textDecoration:'none', color:'#0c1f4d'}}>
