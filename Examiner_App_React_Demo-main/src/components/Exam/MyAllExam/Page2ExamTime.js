        ...
        <form className="" onSubmit={handleSubmit}>
          <div className="row mb-3">
            ...
            <div className="col-md-8 col-lg-9  form-switch">
              <input name="is_time_limit" className="form-check-input" type="checkbox" id="is_time_limit" checked={exam?.is_time_limit && 'checked'}  onChange={onChangeHanlder} onClick={onIsTimeLimitChange}/>
            </div>
          </div>
          {
            isTimeLimit
