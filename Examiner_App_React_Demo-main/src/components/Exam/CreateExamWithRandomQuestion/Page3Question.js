...
const Page3Question = ({
  ...
  const getTotalQuestion = async () => {
    try {
      ...
      const response = await axios.get(`/api/author/total_question/`, {
        headers,
      });
          ...
          <div className="card" style={{ width: "400px" }}>
            <div className="card-body">
              <div className="row mb-3">
                <label
                  htmlFor="is_level_wise"
                  className="col-md-6 col-lg-6 col-form-label  custom-form-label-secondary"
                >
                  Level Wise
                </label>
