  ...
  switch (type) {
    case "AddEasy":
      if (maxQuestion > state.easyQuestion) {
        return {
          ...state,
          ["easyQuestion"]: state.easyQuestion + 1,
          ["totalQuestion"]: state.totalQuestion + 1,
          ["error"]: "",
        };
      } else {
        return {
          ...state,
          ["error"]: `Only ${maxQuestion} Easy Questions Available`,
        };
      }
    case "RemoveEasy":
      if (state.easyQuestion > 0) {
        ...
        return {
          ...state,
          ["error"]: `Number of Questions can not be Negative`,
        };
      }
    ...
    case "AddMedium":
      if (maxQuestion > state.mediumQuestion) {
        return {
          ...state,
          ["mediumQuestion"]: state.mediumQuestion + 1,
          ["totalQuestion"]: state.totalQuestion + 1,
          ["error"]: "",
        };
      } else {
        return {
          ...state,
          ["error"]: `Only ${maxQuestion} Medium Questions Available`,
        };
      }
    case "RemoveMedium":
    ...
    case "AddHard":
      if (maxQuestion > state.hardQuestion) {
        return {
          ...state,
          ["hardQuestion"]: state.hardQuestion + 1,
          ["totalQuestion"]: state.totalQuestion + 1,
          ["error"]: "",
        };
      } else {
        return {
          ...state,
          ["error"]: `Only ${maxQuestion} Hard Questions Available`,
        };
      }
    case "RemoveHard":
    ...
    case "AddRandom":
      if (maxQuestion > state.randomQuestion) {
        return {
          ...state,
          ["randomQuestion"]: state.randomQuestion + 1,
          ["totalQuestion"]: state.totalQuestion + 1,
          ["error"]: "",
        };
      } else {
        return {
          ...state,
          ["error"]: `Only ${maxQuestion} Questions Available`,
        };
      }
    case "RemoveRandom":
