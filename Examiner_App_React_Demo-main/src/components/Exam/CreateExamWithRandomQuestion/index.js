...
const CreateExamWithRandomQuestion = () => {
  ...
  const onCreateExam = async(body) =>{
    try{
      ...
      const response = await axios.post(`/api/examiner/create_exam_with_random_questions/`,body,{headers});
            ...
            <div className="col-lg-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">Create New Exam with Random Question</h5>
                  <CreateExamWithRandomQuestionForm onCreateExam={onCreateExam}/>
                </div>
              </div>
            </div>
          </div>
