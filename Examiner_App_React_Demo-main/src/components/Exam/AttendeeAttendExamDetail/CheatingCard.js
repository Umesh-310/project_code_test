            ...
            <div className='col-12'>
              {
                ...
                ?
                <>
                  <h5 className="card-title" style={{color:'red'}}>Detected &nbsp;
                    <span className="badge bg-danger text-white">{data?.total_cheat} Paste</span>
                  </h5>
                </>
                :
                <> 
                  <h5 className="card-title" style={{color:'green'}}>Not Detected</h5>
                </>
              }
            </div>          
          </div>
