        ...
        <form onSubmit={onFormSubmitHandler}>
          <div className="row mb-3">
            ...
            <div className="col-md-8 col-lg-9">
              <input name="newpassword" type="password" className="form-control" id="newPassword" value={password} onChange={(e)=>setPassword(e.target.value.trim())}/>
            </div>
          </div>
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-8 col-lg-9">
              <input name="renewpassword" type="password" className="form-control" id="renewPassword" value={password2} onChange={(e)=>setPassword2(e.target.value.trim())}/>
            </div>
          </div>
