        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-4">
              <h2 data-aos="fade-up">Evaluate candidates quickly, affordably, and accurately.</h2>
              <blockquote data-aos="fade-up" data-aos-delay="100">
                <p>The #1 platform for technical assessments, interviews, and take-home projects. All plans include unlimited candidates and admins.</p>
              </blockquote>
                ...
                <div className="slides-1 swiper">
                  <div className="swiper-wrapper">
                    ...
                    <div className="swiper-slide">
                      <div className="item">
                        <h3 className="mb-3">Powerful evaluation capabilities for every stage of the hiring process</h3>
                        <h4 className="mb-3">Accelerate remote and in-person hiring with our end-to-end platform</h4>
