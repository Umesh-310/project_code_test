        ...
        <div className="card">
            <div className="card-body">
              ...
              <div className="card-body pt-3"  style={{textAlign:'center'}}>
                <div className='row'>
                  <h3 className="custom-form-label">Thank You for Attempt Exam</h3>
                  <h4 className="custom-form-label">Contact Your Examiner for Marks</h4>
                </div>
                <div className='row'>
                  <div className='col-md-12'>
                  <img src={process.env.PUBLIC_URL + "/assets/img/attend_exam_end_bg.jpg"} alt="..." style={{height:'500px'}}/>
                  </div>
                </div>
              </div>
            </div>
