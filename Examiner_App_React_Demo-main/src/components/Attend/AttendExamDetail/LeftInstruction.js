    ...
    <>
          ...
          remainTime?.hours > 0 || remainTime?.minutes > 0 ? (
            <span className="text-secondary p-0">
              ...
              <span style={{ fontWeight: "bold" }}>
                {remainTime?.hours} hours, {remainTime?.minutes} minutes
              </span>
            </span>
          ) : (
            <span className="text-secondary p-0">
      ...
      <div className="row mb-3">
        <h6 className="text-secondary p-0">
          Welcome to Your CoderTest Assesment. Try and Solve the challenges and
          answer the questions with this assesment to the best of your ability.
          Good Luck!
        </h6>
      </div>
      <div className="row mb-3">
        <button
          ...
          onClick={endAttendExamHandler}
          style={{ width: "200px" }}
        >
          {isFinalSubmitLoading ? <> Loading... </> : "Submit Assessment"}
        </button>
      </div>
    </>
  );
