      ...
      <div className="row mb-3 col-12">
        <div className="form-check">
          ...
          <label
            ...
            htmlFor="gridCheck"
          >
            I understand that Once I begin this assesment I can not leave and
            return to this assesment at a later time.
          </label>
        </div>
      </div>
      <div
      ...
      >
        ...
        {exam?.is_time_limit ? (
          <span className="text-secondary">
            ...
            {exam?.time_limit_hour} hours, {exam?.time_limit_minute} minutes
          </span>
        ) : (
