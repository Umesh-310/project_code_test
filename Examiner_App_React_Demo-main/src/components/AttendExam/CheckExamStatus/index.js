    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (response?.data?.data?.extra?.start_now) {
          ...
          response?.data?.data?.extra?.start_now_msg === "not_started"
        ) {
          ...
          response?.data?.data?.extra?.start_now_msg === "not_enough_time"
        ) {
              ...
              {examStatus === "check" ? (
                <div className="row">
                  ...
                  <h4 className="custom-form-label">
                    Checking for Exam Starting Status....
                  </h4>
                </div>
                ...
                <div className="row">
                  ...
                  >
                    ...
                    <span style={{ color: "red" }}>
                      {startAt.slice(0, 10)} {startAt.slice(11, 16)}
                    </span>
                  </h3>
                  <h4 className="custom-form-label">
                    You have to Wait OR Contact Your Examiner
                  </h4>
                </div>
              ) : examStatus === "closed" ? (
                <div className="row">
                ...
                <div className="row">
                  <h3
                    ...
                    style={{ fontWeight: "bold" }}
                  >
                    You do NOT have Enough Time to Attempt Exam
                  </h3>
                  <h4 className="custom-form-label">Contact Your Examiner</h4>
                </div>
              ) : (
                ...
                <div className="col-md-12">
                  <img
                    src={
                      ...
                      "/assets/img/attend_exam_wait_bg.jpg"
                    }
                    alt="..."
                    style={{ height: "500px" }}
                  />
