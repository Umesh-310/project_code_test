...
!(function (t, e) {
  ...
  function Yt(t, e, n, i, o) {
    if (e.getBoundingClientRect && r.domSupported && !qt(e)) {
  ...
  function Kt(t) {
    return null == t
      ? ""
      : (t + "").replace(Zt, function (t, e) {
          return jt[e];
        });
  }
  var $t = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
    Qt = [],
    Jt = r.browser.firefox && +r.browser.version.split(".")[0] < 39;
  function te(t, e, n, i) {
    return (
      (n = n || {}),
      i
        ? ee(t, e, n)
        : Jt && null != e.layerX && e.layerX !== e.offsetX
  ...
  function ee(t, e, n) {
    if (r.domSupported && t.getBoundingClientRect) {
      ...
      if (Yt(Qt, t, i, o)) return (n.zrX = Qt[0]), void (n.zrY = Qt[1]);
    }
    n.zrX = n.zrY = 0;
  }
  function ne(t) {
  ...
  var re = (function () {
    ...
    return (
      ...
      (t.prototype._recognize = function (t) {
        for (var e in ae)
          if (ae.hasOwnProperty(e)) {
            var n = ae[e](this._track, t);
            if (n) return n;
          }
      }),
      t
      ...
      return (
        (t.prototype.union = function (t) {
          ...
          isFinite(this.x) && isFinite(this.width)
            ? (this.width = me(t.x + t.width, this.x + this.width) - e)
            : (this.width = t.width),
            isFinite(this.y) && isFinite(this.height)
              ? (this.height = me(t.y + t.height, this.y + this.height) - n)
        ...
        (t.prototype.calculateTransform = function (t) {
          var e = this,
            ...
            r = [1, 0, 0, 1, 0, 0];
          return (
            ce(r, r, [-e.x, -e.y]), fe(r, r, [n, i]), ce(r, r, [t.x, t.y]), r
          );
        }),
        (t.prototype.intersect = function (e, n) {
          ...
          if (n) {
            var f = 1 / 0,
              ...
              x = Math.min(v, m);
            o < l || u < r
              ? _ > d && ((d = _), g < y ? ye.set(Me, -g, 0) : ye.set(Me, y, 0))
              : _ < f &&
                ((f = _), g < y ? ye.set(Se, g, 0) : ye.set(Se, -y, 0)),
              s < h || c < a
                ? x > d &&
                  ((d = x), v < m ? ye.set(Me, 0, -v) : ye.set(Me, 0, m))
                : _ < f &&
                  ((f = _), v < m ? ye.set(Se, 0, v) : ye.set(Se, 0, -m));
          }
          return n && ye.copy(n, p ? Se : Me), p;
        }),
        ...
        (t.applyTransform = function (e, n, i) {
          if (i) {
            ...
            (_e.x = we.x = n.x),
              (_e.y = be.y = n.y),
              (xe.x = be.x = n.x + n.width),
              (xe.y = we.y = n.y + n.height),
              _e.transform(i),
              be.transform(i),
              xe.transform(i),
              we.transform(i),
              (e.x = ve(_e.x, xe.x, we.x, be.x)),
              (e.y = ve(_e.y, xe.y, we.y, be.y));
            var l = me(_e.x, xe.x, we.x, be.x),
              u = me(_e.y, xe.y, we.y, be.y);
    ...
    Pe = (function (t) {
      ...
      return (
        ...
        (e.prototype.mousemove = function (t) {
          ...
          var a = (this._hovered = i ? new ke(e, n) : this.findHover(e, n)),
            s = a.target,
            l = this.proxy;
        ...
        (e.prototype.findHover = function (t, e, n) {
          var i = this.storage.getDisplayList(),
            r = new ke(t, e);
          if ((Re(i, r, t, e, n), this._pointerSize && !r.target)) {
            for (
              var o = [],
                a = this._pointerSize,
                s = a / 2,
                l = new Te(t - s, e - s, a, a),
                u = i.length - 1;
              u >= 0;
              u--
            ) {
              ...
              h === n ||
                ...
                h.transform && Le.applyTransform(h.transform),
                Le.intersect(l) && o.push(h));
            }
            if (o.length)
              for (var c = Math.PI / 12, p = 2 * Math.PI, f = 0; f < s; f += 4)
                for (var d = 0; d < p; d += c) {
                  if (
                    (Re(o, r, t + f * Math.cos(d), e + f * Math.sin(d), n),
                    r.target)
                  )
                    return r;
                }
        ...
        (e.prototype.processGesture = function (t, e) {
          this._gestureMgr || (this._gestureMgr = new re());
  ...
  function Re(t, e, n, i, r) {
    for (var o = t.length - 1; o >= 0; o--) {
      ...
      if (
        ...
        !a.ignore &&
        (s = Oe(a, n, i)) &&
        (!e.topTarget && (e.topTarget = a), s !== Ce)
      ) {
        e.target = a;
        break;
      }
  ...
  function Ve(t, e) {
    ...
    function s(s) {
      ...
      (i[s] = u + c),
        ...
        o--;
      var p = Fe(t[h], t, l, u, 0, e);
      (l += p),
        0 !== (u -= p) &&
          0 !== (c = Be(t[l + u - 1], t, h, c, c - 1, e)) &&
          (u <= c
            ? (function (n, i, o, s) {
                var l = 0;
  ...
  function He(t, e, n, i) {
    ...
    if (!(r < 2)) {
      var o = 0;
      if (r < 32) ze(t, n, i, n + (o = Ee(t, n, i, e)), e);
      else {
        var a = Ve(t, e),
          s = (function (t) {
  ...
  var Xe = (function () {
      ...
      return (
        ...
        (t.prototype.updateDisplayList = function (t) {
          ...
          (n.length = this._displayListLen), He(n, Ue);
        }),
            ...
            if (t.childrenRef) {
              ...
              e && e.length
                ...
                : u.__clipPaths &&
                  ...
                  (u.__clipPaths = []),
                isNaN(u.z) && (Ge(), (u.z = 0)),
                isNaN(u.z2) && (Ge(), (u.z2 = 0)),
                isNaN(u.zlevel) && (Ge(), (u.zlevel = 0)),
  ...
  function ln(t, e, n, i, r, o) {
    ...
    if (rn(h) && rn(c)) {
      ...
      if (rn(d)) {
        ...
        (M =
          (-s -
            ((m = m < 0 ? -Ze(-m, Je) : Ze(m, Je)) +
              (_ = _ < 0 ? -Ze(-_, Je) : Ze(_, Je)))) /
          (3 * a)) >= 0 &&
          M <= 1 &&
          (o[f++] = M);
      } else {
        var x = (2 * h * s - 3 * a * c) / (2 * je(h * h * h)),
          w = Math.acos(x) / 3,
          b = je(h),
          S = Math.cos(w),
          M = (-s - 2 * b * S) / (3 * a),
          T =
            ((y = (-s + b * (S + Qe * Math.sin(w))) / (3 * a)),
            (-s + b * (S - Qe * Math.sin(w))) / (3 * a));
        M >= 0 && M <= 1 && (o[f++] = M),
          y >= 0 && y <= 1 && (o[f++] = y),
          T >= 0 && T <= 1 && (o[f++] = T);
      }
  ...
  var _n = (function () {
      ...
      return (
        ...
        (t.prototype.setEasing = function (t) {
          (this.easing = t), (this.easingFunc = W(t) ? t : qe[t] || mn(t));
        }),
        t
      );
    })(),
  ...
  var Pn = new bn(20),
    On = null;
  function Rn(t, e) {
    On && Ln(On, e), (On = Pn.put(t, On || e.slice()));
  }
  function Nn(t, e) {
    if (t) {
      e = e || [];
      ...
      if (i in Sn) return Ln(e, Sn[i]), Rn(t, e), e;
      var r,
        o = i.length;
      if ("#" === i.charAt(0))
        return 4 === o || 5 === o
  ...
  function zn(t, e) {
    ...
    if (n) {
      ...
      return Wn(n, 4 === n.length ? "rgba" : "rgb");
    }
  }
  function Bn(t, e, n) {
  ...
  var Un = Object.freeze({
    ...
    modifyAlpha: function (t, e) {
      var n = Nn(t);
      if (n && null != e) return (n[3] = Tn(e)), Wn(n, "rgba");
    },
    stringify: Wn,
    lum: Gn,
    random: function () {
  ...
  var Xn = Array.prototype.slice;
  function Yn(t, e, n) {
    return (e - t) * n + t;
  }
  function qn(t, e, n, i) {
    for (var r = e.length, o = 0; o < r; o++) t[o] = Yn(e[o], n[o], i);
    return t;
  }
  function Zn(t, e, n, i) {
  ...
  function $n(t, e, n) {
    ...
    if (i.push && r.push) {
      ...
      if (o !== a)
        if (o > a) i.length = a;
        else for (var s = o; s < a; s++) i.push(1 === n ? r[s] : Xn.call(r[s]));
  ...
  function Qn(t) {
    if (O(t)) {
      var e = t.length;
      if (O(t[0])) {
        for (var n = [], i = 0; i < e; i++) n.push(Xn.call(t[i]));
        return n;
      }
      return Xn.call(t);
    }
      ...
      return (
        ...
        (t.prototype.addKeyframe = function (t, e, n) {
          ...
          if (O(e)) {
            ...
            (h.colorStops = N(e.colorStops, function (t) {
              return { offset: t.offset, color: Nn(t.color) };
            })),
              "linear" === e.type
                ? (a = 4)
                : (function (t) {
          ...
          return (
            n && ((c.easing = n), (c.easingFunc = W(n) ? n : qe[n] || mn(n))),
            i.push(c),
            c
          );
        }),
          ...
          for (
            ...
            (h.percent = h.time / t),
              a ||
                (s && u !== r - 1
                  ? $n(c, p, i)
                  : l && Kn(c.colorStops, p.colorStops));
          }
          if (
            !a &&
            5 !== i &&
            ...
            for (u = 0; u < r; u++)
              0 === i
                ...
                : 3 === i
                ? (n[u].additiveValue = Zn([], n[u].value, f, -1))
                : ei(i) &&
                  (n[u].additiveValue =
                    1 === i
                      ? Zn([], n[u].value, f, -1)
        ...
        (t.prototype.step = function (t, e) {
          if (!this._finished) {
            ...
            if (i && r) {
              ...
              var y = o ? this._additiveValue : c ? ni : t[h];
              if (
                ((!ei(s) && !c) || y || (y = this._additiveValue = []),
                this.discrete)
              )
                ...
                (t[h] = {
                  ...
                  colorStops: N(v.colorStops, function (t, e) {
                    ...
                    return {
                      offset: Yn(t.offset, n.offset, g),
                      color: Jn(qn([], t.color, n.color, g)),
                    };
                  }),
                  global: m.global,
                }),
                  _
                    ? ((t[h].x2 = Yn(v.x2, m.x2, g)),
                      (t[h].y2 = Yn(v.y2, m.y2, g)))
                    : (t[h].r = Yn(v.r, m.r, g));
              } else if (c) qn(y, i[a], r[a], g), o || (t[h] = Jn(y));
              else {
                var x = Yn(i[a], r[a], g);
        ...
        (t.prototype._addToTarget = function (t) {
          ...
          0 === e
            ? (t[n] = t[n] + i)
            : 3 === e
            ? (Nn(t[n], ni), Zn(ni, ni, i, 1), (t[n] = Jn(ni)))
            : 1 === e
            ? Zn(t[n], t[n], i, 1)
            : 2 === e && jn(t[n], t[n], i, 1);
        }),
          ...
          for (var r = this._tracks, o = 0; o < n.length; o++) {
            ...
            if (!s) {
              ...
              if (u) {
                var h = u.keyframes,
                  c = h[h.length - 1];
                (l = c && c.value), 3 === u.valType && l && (l = Jn(l));
              } else l = this._target[a];
              if (null == l) continue;
              t > 0 && s.addKeyframe(0, Qn(l), i), this._trackKeys.push(a);
            }
            s.addKeyframe(t, Qn(e[a]), i);
          }
  ...
  var ai,
    ...
    li = (function (t) {
      ...
      return (
        ...
        (e.prototype.update = function (t) {
          for (
            var e = oi() - this._pausedTime, n = e - this._time, i = this._head;
            i;
        ...
        (e.prototype._startLoop = function () {
          ...
          (this._running = !0),
            Ye(function e() {
              t._running && (Ye(e), !t._paused && t.update());
            });
        }),
        (e.prototype.start = function () {
          this._running ||
            ((this._time = oi()), (this._pausedTime = 0), this._startLoop());
        }),
        ...
        (e.prototype.resume = function () {
          this._paused &&
            ((this._pausedTime += oi() - this._pauseStart),
            (this._paused = !1));
        }),
    ...
    ui = r.domSupported,
    hi =
      ((si = { pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1 }),
      {
        mouse: (ai = [
          "click",
          "dblclick",
        ...
        pointer: N(ai, function (t) {
          var e = t.replace("mouse", "pointer");
          return si.hasOwnProperty(e) ? e : t;
        }),
      }),
    ci = ["mousemove", "mouseup"],
    pi = ["pointermove", "pointerup"],
    fi = !1;
  function di(t) {
    var e = t.pointerType;
  ...
  var vi = function (t, e) {
    ...
    mi = {
      ...
      mouseout: function (t) {
        yi(this, (t = ie(this.dom, t)).toElement || t.relatedTarget) ||
          (this.__pointerCapturing && (t.zrEventControl = "no_globalout"),
          this.trigger("mouseout", t));
      },
      wheel: function (t) {
        (fi = !0), (t = ie(this.dom, t)), this.trigger("mousewheel", t);
      },
      mousewheel: function (t) {
        fi || ((t = ie(this.dom, t)), this.trigger("mousewheel", t));
      },
      touchstart: function (t) {
        gi((t = ie(this.dom, t))),
          (this.__lastTouchMoment = new Date()),
          this.handler.processGesture(t, "start"),
          mi.mousemove.call(this, t),
          mi.mousedown.call(this, t);
      },
      ...
      touchend: function (t) {
        gi((t = ie(this.dom, t))),
          ...
          mi.mouseup.call(this, t),
          +new Date() - +this.__lastTouchMoment < 300 && mi.click.call(this, t);
      },
      pointerdown: function (t) {
        mi.mousedown.call(this, t);
      },
      pointermove: function (t) {
        di(t) || mi.mousemove.call(this, t);
      },
      pointerup: function (t) {
        mi.mouseup.call(this, t);
      },
      pointerout: function (t) {
        di(t) || mi.mouseout.call(this, t);
      },
    };
  ...
  function xi(t, e) {
    ...
    r.pointerEventsSupported
      ? R(hi.pointer, function (i) {
          bi(e, i, function (e) {
            n[i].call(t, e);
          });
        })
      : (r.touchEventsSupported &&
          R(hi.touch, function (i) {
            bi(e, i, function (r) {
              n[i].call(t, r),
                (function (t) {
                  (t.touching = !0),
  ...
  function wi(t, e) {
    ...
    r.pointerEventsSupported ? R(pi, n) : r.touchEventsSupported || R(ci, n);
  }
  function bi(t, e, n, i) {
    (t.mounted[e] = n),
      (t.listenerOpts[e] = i),
    ...
    Ti = (function (t) {
      function e(e, n) {
        ...
        return (
          ...
          (i.dom = e),
          (i.painterRoot = n),
          (i._localHandlerScope = new Mi(e, mi)),
          ui && (i._globalHandlerScope = new Mi(document, _i)),
          xi(i, i._localHandlerScope),
          i
        );
      }
      return (
        n(e, t),
        (e.prototype.dispose = function () {
          Si(this._localHandlerScope), ui && Si(this._globalHandlerScope);
        }),
    ...
    zi = (function () {
      ...
      return (
        ...
        (t.prototype.updateTransform = function () {
          ...
          e || t
            ? ((n = n || [1, 0, 0, 1, 0, 0]),
              e ? this.getLocalTransform(n) : Ai(n),
              t && (e ? he(n, t, n) : ue(n, t)),
              (this.transform = n),
        ...
        (t.prototype.decomposeTransform = function () {
          if (this.transform) {
            var t = this.parent,
              e = this.transform;
            t && t.transform && (he(Ri, t.invTransform, e), (e = Ri));
            var n = this.originX,
              i = this.originY;
            (n || i) &&
              ((Ni[4] = n),
        ...
        (t.prototype.getLineScale = function () {
          ...
          return t && Ei(t[0] - 1) > 1e-10 && Ei(t[3] - 1) > 1e-10
            ? Math.sqrt(Ei(t[0] * t[3] - t[2] * t[1]))
            : 1;
        }),
  ...
  function Hi(t, e, n, i) {
    var r = Vi(t, e),
      ...
      a = Gi(0, r, n),
      s = Ui(0, o, i);
    return new Te(a, s, r, o);
  }
  function Wi(t, e, n, i) {
    var r = ((t || "") + "").split("\n");
    if (1 === r.length) return Hi(r[0], e, n, i);
    for (var o = new Te(0, 0, 0, 0), a = 0; a < r.length; a++) {
      var s = Hi(r[a], e, n, i);
      ...
      return (
            ...
            if ((r.copyTransform(e), null != n.position)) {
              ...
              n.layoutRect
                ...
                this.calculateTextPosition
                  ? this.calculateTextPosition($i, n, u)
                  : qi($i, n, u),
                (r.x = $i.x),
                (r.y = $i.y),
                (o = $i.align),
              ...
              if (h && null != n.rotation) {
                ...
                "center" === h
                  ...
                  : ((c = Yi(h[0], u.width)), (p = Yi(h[1], u.height))),
                  (l = !0),
        ...
        (t.prototype._innerSaveToNormal = function (t) {
          ...
          e || (e = this._normalState = {}),
            ...
            this._savePrimaryToNormal(t, e, ji);
        }),
        ...
        (t.prototype._applyStateObj = function (t, e, n, i, r, o) {
          var a = !(e && i);
          e && e.textConfig
            ? ((this.textConfig = I({}, i ? this.textConfig : n.textConfig)),
              I(this.textConfig, e.textConfig))
            : a && n.textConfig && (this.textConfig = n.textConfig);
          for (var s = {}, l = !1, u = 0; u < ji.length; u++) {
            var h = ji[u],
              c = r && Ki[h];
            e && null != e[h]
              ? c
        ...
        (t.prototype._transitionState = function (t, e, n, i) {
          for (var r = tr(this, e, n, i), o = 0; o < r.length; o++)
      ...
      (e.prototype.getBoundingRect = function (t) {
        for (
          ...
          if (!a.ignore && !a.invisible) {
            ...
            l
              ? (Te.applyTransform(e, s, l), (r = r || e.clone()).union(e))
              : (r = r || s.clone()).union(s);
          }
        }
        return r || e;
  ...
  var sr = (function () {
    function t(t, e, n) {
      ...
      var s = new or[a](e, o, n, t),
        l = n.ssr || s.ssrOnly;
      (this.storage = o), (this.painter = s);
      var u,
        h =
          r.node || r.worker || l ? null : new Ti(s.getViewportRoot(), s.root),
        c = n.useCoarsePointer;
      (null == c || "auto" === c ? r.touchEventsSupported : !!c) &&
        (u = et(n.pointerSize, 44)),
        (this.handler = new Pe(o, s, h, s.root, u)),
    ...
    return (
      ...
      (t.prototype.setBackgroundColor = function (t) {
        this.painter.setBackgroundColor && this.painter.setBackgroundColor(t),
          ...
          (this._darkMode = (function (t) {
            if (!t) return !1;
            if ("string" == typeof t) return Gn(t, 1) < 0.4;
            if (t.colorStops) {
      ...
      (t.prototype.clear = function () {
        for (var t = this.storage.getRoots(), e = 0; e < t.length; e++)
          t[e] instanceof rr && t[e].removeSelfFromZr(this);
  ...
  var hr = Object.freeze({
      ...
      disposeAll: function () {
        for (var t in ar) ar.hasOwnProperty(t) && ar[t].dispose();
        ar = {};
      },
  ...
  function _r(t, e) {
    var n = Math.max(gr(t), gr(e)),
      i = t + e;
    return n > 20 ? i : dr(i, n);
  }
  function xr(t) {
    var e = 2 * Math.PI;
    return ((t % e) + e) % e;
  ...
  function kr(t, e) {
    return 0 === e ? t : kr(e, t % e);
  }
  function Ar(t, e) {
    return null == t ? e : null == e ? t : (t * e) / kr(t, e);
  }
      ...
      u = (function (t, e, n) {
        ...
        for (var r = 0; r < t.length; r++) {
          ...
          o && null != o.id && e.set(o.id, r),
            i.push({
              existing: "replaceMerge" === n || Xr(o) ? null : o,
              newOption: null,
              keyInfo: null,
              brandNew: null,
            });
    ...
    return (
            ...
            R(e, function (e) {
              if (e) {
                for (
                  ...
                  (i.newOption ||
                    Xr(i.existing) ||
                    (i.existing && null != e.id && !Hr("id", e, i.existing)));
      ...
      R(s, function (t, e) {
        var n = t.existing,
          ...
          r = t.keyInfo;
        if (Y(i)) {
          if (((r.name = null != i.name ? Wr(i.name) : n ? n.name : Rr + e), n))
            r.id = Wr(n.id);
          else if (null != i.id) r.id = Wr(i.id);
          else {
            var o = 0;
            do {
              r.id = "\0" + r.name + "\0" + o++;
  ...
  function Ur(t) {
    var e = t.name;
    return !(!e || !e.indexOf(Rr));
  }
  function Xr(t) {
    return t && null != t.id && 0 === Wr(t.id).indexOf("\0_ec_\0");
  }
  function Yr(t, e) {
  ...
  function qr() {
    var t = "__ec_inner_" + Zr++;
    return function (e) {
      return e[t] || (e[t] = {});
    };
  }
  var Zr = Math.round(9 * Math.random());
  function jr(t, e, n) {
    var i = Kr(e, n),
  ...
  var $r = { useDefault: !0, enableAll: !1, enableNone: !1 };
  function Qr(t, e, n, i) {
    i = i || $r;
    var r = n.index,
      o = n.id,
  ...
  var to = "___EC__COMPONENT__CONTAINER___",
    eo = "___EC__EXTENDED_CLASS___";
  function no(t) {
    var e = { main: "", sub: "" };
    if (t) {
      var n = t.split(".");
  ...
  var oo = Math.round(10 * Math.random());
  function ao(t, e) {
  ...
  function go(t, e, n, i, r) {
    if (t) {
      if ("string" == typeof t) {
        ...
        return (
          o
            ? !vo((e = o.image)) && o.pending.push(a)
            : (((e = u.loadImage(t, yo, yo)).__zrImageSrc = t),
              po.put(t, (e.__cachedImgObj = { image: e, pending: [a] }))),
          e
        );
      }
      return t;
  ...
  function _o(t, e, n, i, r) {
    ...
    var o = (t + "").split("\n");
    r = xo(e, n, i, r);
    for (var a = 0, s = o.length; a < s; a++) o[a] = wo(o[a], r);
    return o.join("\n");
  }
  function xo(t, e, n, i) {
    var r = I({}, (i = i || {}));
  ...
  function wo(t, e) {
    ...
    for (var a = 0; ; a++) {
      ...
      var s =
        0 === a
          ? bo(t, r, e.ascCharWidth, e.cnCharWidth)
          : o > 0
          ? Math.floor((t.length * r) / o)
          : 0;
      o = Vi((t = t.substr(0, s)), i);
    }
  ...
  function Co(t, e, n, i, r) {
    ...
    if (i) {
      ...
      if (null != l.width && "auto" !== l.width) {
        var d = Yi(l.width, i.width) + f;
        u.length > 0 &&
          d + i.accumWidth > i.width &&
          ((o = e.split("\n")), (c = !0)),
          (i.accumWidth = d);
      } else {
        var g = ko(e, h, i.width, i.breakAll, i.accumWidth);
    ...
    for (var y = 0; y < o.length; y++) {
      ...
      if (
        ...
        "number" == typeof l.width
          ? (m.width = l.width)
          : (m.width = a ? a[y] : Vi(v, h)),
        y || c)
      )
        u.push(new Mo([m]));
      else {
        var _ = (u[u.length - 1] || (u[0] = new Mo())).tokens,
          x = _.length;
  ...
  var Ao = "__zr_style_" + Math.round(10 * Math.random()),
    Lo = {
      shadowBlur: 0,
      shadowOffsetX: 0,
      shadowOffsetY: 0,
      ...
      return (
        ...
        (e.prototype.shouldBePainted = function (t, e, n, i) {
          ...
          if (
            ...
            (this.culling &&
              (function (t, e, n) {
                Eo.copy(t.getBoundingRect()),
                  t.transform && Eo.applyTransform(t.transform);
                return (zo.width = e), (zo.height = n), !Eo.intersect(zo);
              })(this, t, e)) ||
            (r && !r[0] && !r[3])
          )
            return !1;
        ...
        (e.prototype.getPaintRect = function () {
          ...
          if (!this._paintRect || this.__dirty) {
            var e = this.transform,
              ...
              o = i.shadowOffsetX || 0,
              a = i.shadowOffsetY || 0;
            (t = this._paintRect || (this._paintRect = new Te(0, 0, 0, 0))),
              e ? Te.applyTransform(t, n, e) : t.copy(n),
              (r || o || a) &&
        ...
        (e.prototype.setPrevPaintRect = function (t) {
          t
            ? ((this._prevPaintRect =
                this._prevPaintRect || new Te(0, 0, 0, 0)),
        ...
        (e.prototype.setStyle = function (t, e) {
          return (
            "string" == typeof t ? (this.style[t] = e) : I(this.style, t),
            this.dirtyStyle(),
            this
          );
        }),
        ...
        (e.prototype._innerSaveToNormal = function (e) {
          ...
          e.style &&
            ...
            this._savePrimaryToNormal(e, n, Oo);
        }),
  ...
  function Yo(t, e, n, i, r, o) {
    (r[0] = Bo(t, n)), (r[1] = Bo(e, i)), (o[0] = Fo(t, n)), (o[1] = Fo(e, i));
  }
  var qo = [],
    Zo = [];
  function jo(t, e, n, i, r, o, a, s, l, u) {
    var h = un,
      c = an,
      p = h(t, n, r, a, qo);
    ...
    for (var f = 0; f < p; f++) {
      ...
      (l[0] = Bo(d, l[0])), (u[0] = Fo(d, u[0]));
    }
    p = h(e, i, o, s, Zo);
    for (f = 0; f < p; f++) {
      var g = c(e, i, o, s, Zo[f]);
      (l[1] = Bo(g, l[1])), (u[1] = Fo(g, u[1]));
    }
    (l[0] = Bo(t, l[0])),
      (u[0] = Fo(t, u[0])),
      (l[0] = Bo(a, l[0])),
  ...
  var Qo = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
    ...
    ha = Math.PI,
    ca = 2 * ha,
    pa = "undefined" != typeof Float32Array,
    fa = [];
  function da(t) {
  ...
  var ga = (function () {
    ...
    return (
      ...
      (t.prototype.setScale = function (t, e, n) {
        (n = n || 0) > 0 &&
          ((this._ux = ua(n / Ii / t) || 0), (this._uy = ua(n / Ii / e) || 0));
      }),
      ...
      (t.prototype.toStatic = function () {
        if (this._saveData) {
          ...
          t instanceof Array &&
            ((t.length = this._len),
            pa && this._len > 11 && (this.data = new Float32Array(t)));
        }
      }),
      (t.prototype.getBoundingRect = function () {
        (ea[0] = ea[1] = ia[0] = ia[1] = Number.MAX_VALUE),
        ...
        for (t = 0; t < this._len; ) {
          ...
          switch ((s && ((r = n = e[t]), (o = i = e[t + 1])), a)) {
            case Qo.M:
              ...
              break;
            case Qo.L:
              Yo(n, i, e[t], e[t + 1], ia, ra), (n = e[t++]), (i = e[t++]);
              break;
            case Qo.C:
              jo(n, i, e[t++], e[t++], e[t++], e[t++], e[t], e[t + 1], ia, ra),
                (n = e[t++]),
                (i = e[t++]);
              break;
            case Qo.Q:
              Ko(n, i, e[t++], e[t++], e[t], e[t + 1], ia, ra),
                (n = e[t++]),
                (i = e[t++]);
              break;
            case Qo.A:
              ...
              t += 1;
              var d = !e[t++];
              s && ((r = sa(p) * h + l), (o = la(p) * c + u)),
                $o(l, u, h, c, p, f, d, ia, ra),
                (n = sa(f) * h + l),
                (i = la(f) * c + u);
              break;
            case Qo.R:
          ...
          zt(ea, ea, ia), Bt(na, na, ra);
        }
        return (
          0 === t && (ea[0] = ea[1] = na[0] = na[1] = 0),
          new Te(ea[0], ea[1], na[0] - ea[0], na[1] - ea[1])
        );
      }),
          ...
          switch (p) {
            ...
            case Qo.C:
              var v = t[c++],
                ...
                x = t[c++],
                w = t[c++];
              (d = cn(r, o, v, m, g, _, x, w, 10)), (r = x), (o = w);
              break;
            case Qo.Q:
              (d = yn(
                r,
            ...
            case Qo.A:
              ...
              c += 1;
              t[c++];
              f && ((a = sa(C) * M + b), (s = la(C) * T + S)),
                (d = aa(M, T) * oa(ca, Math.abs(I))),
                (r = sa(D) * M + b),
                (o = la(D) * T + S);
              break;
            case Qo.R:
          ...
          t: for (var x = 0; x < g; ) {
            ...
            switch (
              ...
              case Qo.C:
                ...
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    hn(r, I, k, L, (T = (u - v) / Z), Jo),
                      hn(o, D, A, P, T, ta),
                      t.bezierCurveTo(Jo[1], ta[1], Jo[2], ta[2], Jo[3], ta[3]);
                    break t;
                  }
                  v += Z;
                }
                t.bezierCurveTo(I, D, k, A, L, P), (r = L), (o = P);
                break;
              case Qo.Q:
                (I = p[x++]), (D = p[x++]), (k = p[x++]), (A = p[x++]);
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    gn(r, I, k, (T = (u - v) / Z), Jo),
                      gn(o, D, A, T, ta),
                      t.quadraticCurveTo(Jo[1], ta[1], Jo[2], ta[2]);
                    break t;
                  }
                  v += Z;
                }
                t.quadraticCurveTo(I, D, k, A), (r = k), (o = A);
                break;
              case Qo.A:
                var O = p[x++],
                  R = p[x++],
              ...
              case Qo.R:
                ...
                if (y) {
                  if (v + (Z = l[m++]) > u) {
                    ...
                    t.moveTo(a, s),
                      t.lineTo(a + oa(q, X), s),
                      (q -= X) > 0 && t.lineTo(a + X, s + oa(q, Y)),
                      (q -= Y) > 0 && t.lineTo(a + aa(X - q, 0), s + Y),
                      (q -= X) > 0 && t.lineTo(a, s + aa(Y - q, 0));
                    break t;
                  }
                  v += Z;
                }
  ...
  function va(t, e, n, i, r, o, a, s, l, u, h) {
    ...
    var p = (function (t, e, n, i, r, o, a, s, l, u, h) {
      ...
      for (var m = 0; m < 1; m += 0.05)
        (en[0] = an(t, n, r, a, m)),
          (en[1] = an(e, i, o, s, m)),
          (d = Rt(tn, en)) < v && ((c = m), (v = d));
      v = 1 / 0;
      for (var _ = 0; _ < 32 && !(y < $e); _++)
        (p = c - y),
          (f = c + y),
          (en[0] = an(t, n, r, a, p)),
          (en[1] = an(e, i, o, s, p)),
      ...
      return (
        h && ((h[0] = an(t, n, r, a, c)), (h[1] = an(e, i, o, s, c))), je(v)
      );
  ...
  function ma(t, e, n, i, r, o, a, s, l) {
    ...
    var h = (function (t, e, n, i, r, o, a, s, l) {
      ...
      for (var p = 0; p < 1; p += 0.05)
        (en[0] = pn(t, n, r, p)),
          (en[1] = pn(e, i, o, p)),
          (y = Rt(tn, en)) < c && ((u = p), (c = y));
      c = 1 / 0;
      for (var f = 0; f < 32 && !(h < $e); f++) {
        var d = u - h,
          g = u + h;
        (en[0] = pn(t, n, r, d)), (en[1] = pn(e, i, o, d));
        var y = Rt(en, tn);
        if (d >= 0 && y < c) (u = d), (c = y);
        else {
          (nn[0] = pn(t, n, r, g)), (nn[1] = pn(e, i, o, g));
          var v = Rt(nn, tn);
          g <= 1 && v < c ? ((u = g), (c = v)) : (h *= 0.5);
        }
      }
      return l && ((l[0] = pn(t, n, r, u)), (l[1] = pn(e, i, o, u))), je(c);
    })(t, e, n, i, r, o, s, l, null);
    return h <= u / 2;
  }
  var _a = 2 * Math.PI;
  function xa(t) {
    return (t %= _a) < 0 && (t += _a), t;
  }
  var wa = 2 * Math.PI;
  function ba(t, e, n, i, r, o, a, s, l) {
    if (0 === a) return !1;
    var u = a;
    (s -= t), (l -= e);
    var h = Math.sqrt(s * s + l * l);
    if (h - u > n || h + u < n) return !1;
    if (Math.abs(i - r) % wa < 1e-4) return !0;
    if (o) {
      var c = i;
      (i = xa(r)), (r = xa(c));
    } else (i = xa(i)), (r = xa(r));
    ...
    return (
      p < 0 && (p += wa), (p >= i && p <= r) || (p + wa >= i && p + wa <= r)
    );
  }
  ...
  function ka(t, e, n, i, r, o, a, s) {
    ...
    var l = (function (t, e, n, i, r) {
      var o = t - 2 * e + n,
        ...
        s = t - i,
        l = 0;
      if (rn(o)) on(a) && (h = -s / a) >= 0 && h <= 1 && (r[l++] = h);
      else {
        var u = a * a - 4 * o * s;
        if (rn(u)) (h = -a / (2 * o)) >= 0 && h <= 1 && (r[l++] = h);
        else if (u > 0) {
          var h,
            c = je(u),
            p = (-a - c) / (2 * o);
    ...
    var u = dn(e, i, o);
    if (u >= 0 && u <= 1) {
      for (var h = 0, c = pn(e, i, o, u), p = 0; p < l; p++) {
        var f = 0 === Ca[p] || 1 === Ca[p] ? 0.5 : 1;
        pn(t, n, r, Ca[p]) < a ||
          (Ca[p] < u ? (h += c < e ? f : -f) : (h += o < c ? f : -f));
      }
      return h;
    }
    f = 0 === Ca[0] || 1 === Ca[0] ? 0.5 : 1;
    return pn(t, n, r, Ca[0]) < a ? 0 : o < e ? f : -f;
  }
  ...
  function La(t, e, n, i, r) {
    for (
      ...
      switch (
        ...
        case Ma.L:
          if (n) {
            if (ya(p, f, u[y], u[y + 1], e, i, r)) return !0;
          } else c += Sa(p, f, u[y], u[y + 1], i, r) || 0;
          (p = u[y++]), (f = u[y++]);
          break;
        case Ma.C:
          if (n) {
            if (
              va(p, f, u[y++], u[y++], u[y++], u[y++], u[y], u[y + 1], e, i, r)
            )
              return !0;
          } else
            c +=
              Da(p, f, u[y++], u[y++], u[y++], u[y++], u[y], u[y + 1], i, r) ||
              0;
          (p = u[y++]), (f = u[y++]);
          break;
        case Ma.Q:
        ...
        case Ma.A:
          ...
          (o = Math.cos(S) * w + _),
            (a = Math.sin(S) * b + x),
            m ? ((d = o), (g = a)) : (c += Sa(p, f, o, a, i, r));
          var C = ((i - _) * b) / w + _;
          if (n) {
            if (ba(_, x, b, S, S + M, T, e, C, r)) return !0;
          } else c += Aa(_, x, b, S, S + M, T, C, r);
        ...
        case Ma.R:
          if (
            ...
            if (
              ...
              return !0;
          } else (c += Sa(o, g, o, a, i, r)), (c += Sa(d, a, d, g, i, r));
          break;
        case Ma.Z:
          if (n) {
            if (ya(p, f, d, g, e, i, r)) return !0;
          } else c += Sa(p, f, d, g, i, r);
          (p = d), (f = g);
      }
    }
    return (
  ...
  var Pa = D(
    ...
    Ra = Bi.concat(["invisible", "culling", "z", "z2", "zlevel", "parent"]),
    Na = (function (t) {
      function e(e) {
        return t.call(this, e) || this;
      }
      ...
      return (
        ...
        (e.prototype.update = function () {
          ...
          if (i.decal) {
            ...
            for (var s = 0; s < Ra.length; ++s) r[Ra[s]] = this[Ra[s]];
            r.__dirty |= 1;
        ...
        (e.prototype.getInsideTextStroke = function (t) {
          ...
          if (G(e)) {
            var n = this.__zr;
            if (!(!n || !n.isDarkMode()) === Gn(t, 0) < 0.4) return e;
          }
        }),
          ...
          if (
            (n && n.shape
              ? o
                ? r
                  ? (s = n.shape)
                  : ((s = I({}, i.shape)), I(s, n.shape))
                : ((s = I({}, r ? this.shape : i.shape)), I(s, n.shape))
              : l && (s = i.shape),
            s)
          )
            if (o) {
  ...
  function Wa(t, e, n) {
    if (e) {
      ...
      var s = n && n.lineWidth;
      return s
        ? (Ha(2 * i) === Ha(2 * r) && (t.x1 = t.x2 = Ga(i, s, !0)),
          Ha(2 * o) === Ha(2 * a) && (t.y1 = t.y2 = Ga(o, s, !0)),
          t)
        : t;
    }
  }
  function Ga(t, e, n) {
    if (!e) return t;
    var i = Ha(2 * t);
    return (i + Ha(e)) % 2 == 0 ? i / 2 : (i + (n ? 1 : -1)) / 2;
  }
  var Ua = function () {
  ...
  var qa = { fill: "#000" },
    ...
    ja = (function (t) {
      ...
      return (
        ...
        (e.prototype._updatePlainTexts = function () {
          var t = this.style,
            ...
            i = (function (t, e) {
                  ...
                  (n =
                    null == c || ("break" !== i && "breakAll" !== i)
                      ? t
                        ...
                        : []
                      : t
                      ? ko(t, e.font, c, "breakAll" === i, 0).lines
                      : []).length * l,
                f = et(e.height, p);
              if (p > f && h) {
              ...
              var v = f,
                m = 0;
              for (y = 0; y < n.length; y++) m = Math.max(Vi(n[y], o), m);
              null == c && (c = m);
              var _ = m;
              return (
                r &&
          ...
          for (
            var w = 0,
              b = !1,
              S = is(("fill" in t) ? t.fill : ((b = !0), p.fill)),
              M = ns(
                ("stroke" in t)
                  ? t.stroke
                  : a || (p.autoStroke && !b)
            ...
            k.useStyle(A),
              ...
              C &&
                k.setBoundingRect(
                  new Te(
                    Gi(A.x, t.width, A.textAlign),
                    Ui(A.y, I, A.textBaseline),
                    u,
                    I,
                  ),
                );
        ...
        (e.prototype._updateRichTexts = function () {
                  ...
                  if ("string" == typeof I && "%" === I.charAt(I.length - 1))
                    ...
                    null != L && L < P.width
                      ? !D || L < M
                        ...
                        : ((P.text = _o(P.text, L - M, T, e.ellipsis, {
                            minChar: e.truncateMinChar,
                          })),
                          (P.width = P.contentWidth = Vi(P.text, T)))
                      : (P.contentWidth = Vi(P.text, T));
                  }
                  (P.width += M),
                    (x += P.width),
          ...
          o && ((f += o[3]), (d += o[0]));
          var g = f + n;
          as(t) && this._renderBackground(t, t, c, p, i, r);
          for (var y = !!t.backgroundColor, v = 0; v < e.lines.length; v++) {
            for (
              var m = e.lines[v],
                ...
                C = x - 1,
                I = void 0;
              S < x && (!(I = _[S]).align || "left" === I.align);

            )
              this._placeToken(I, t, w, d, M, "left", y),
                (b -= I.width),
                (M += I.width),
                S++;
            for (; C >= 0 && "right" === (I = _[C]).align; )
              this._placeToken(I, t, w, d, T, "right", y),
                (b -= I.width),
                (T -= I.width),
                C--;
            for (M += (n - (M - f) - (g - T) - b) / 2; S <= C; )
              (I = _[S]),
                this._placeToken(I, t, w, d, M + I.width / 2, "center", y),
                (M += I.width),
                S++;
            d += w;
          }
        ...
        (e.prototype._placeToken = function (t, e, n, i, r, a, s) {
          ...
          var c = !!l.backgroundColor,
            p = t.textPadding;
          p &&
            ((r = rs(r, a, p)), (h -= t.height / 2 - p[0] - t.innerHeight / 2));
          var f = this._getOrCreateChild(za),
            d = f.createStyle();
          f.useStyle(d);
          ...
          var w = t.contentWidth,
            b = t.contentHeight;
          f.setBoundingRect(
            new Te(Gi(d.x, w, d.textAlign), Ui(d.y, b, d.textBaseline), w, b),
          );
        }),
        (e.prototype._renderBackground = function (t, e, n, i, r, o) {
          ...
          if (f || t.lineHeight || (h && c)) {
            (a = this._getOrCreateChild(Ya)).useStyle(a.createStyle()),
              (a.style.fill = null);
            var y = a.shape;
            (y.x = n),
              (y.y = i),
          ...
          if (f)
            ...
            (s = this._getOrCreateChild(Va)).onload = function () {
              g.dirtyStyle();
            };
            var v = s.style;
            (v.image = u.image),
    ...
    Ka = { left: !0, right: 1, center: 1 },
    $a = { top: 1, bottom: 1, middle: 1 },
    Qa = ["fontStyle", "fontWeight", "fontSize", "fontFamily"];
  function Ja(t) {
    return "string" != typeof t ||
      (-1 === t.indexOf("px") &&
        -1 === t.indexOf("rem") &&
  ...
  function es(t) {
    if (t) {
      t.font = ja.makeFont(t);
      var e = t.align;
      "middle" === e && (e = "center"),
        (t.align = null == e || Ka[e] ? e : "left");
      var n = t.verticalAlign;
      "center" === n && (n = "middle"),
        (t.verticalAlign = null == n || $a[n] ? n : "top"),
  ...
  function ws(t) {
    if (G(t)) {
      var e = xs.get(t);
      return e || ((e = zn(t, -0.1)), xs.put(t, e)), e;
    }
    if (K(t)) {
      var n = I({}, t);
      return (
        (n.colorStops = N(t.colorStops, function (t) {
          return { offset: t.offset, color: zn(t.color, -0.1) };
        })),
        n
      );
    }
  ...
  function Ms(t) {
    2 === t.hoverState && bs(t, "normal", 0);
  }
  function Ts(t) {
    bs(t, "blur", 1);
  }
  function Cs(t) {
    1 === t.hoverState && bs(t, "normal", 0);
  }
  function Is(t) {
    t.selected = !0;
  }
        ...
        return (function (t, e, n, i) {
          ...
          if (t instanceof Na) {
            ...
            if (_s(s) || _s(l)) {
              var u = (i = i || {}).style || {};
              "inherit" === u.fill
                ? ((o = !0), (i = I({}, i)), ((u = I({}, u)).fill = s))
                : !_s(u.fill) && _s(s)
                ? ((o = !0), (i = I({}, i)), ((u = I({}, u)).fill = ws(s)))
                : !_s(u.stroke) &&
                  _s(l) &&
                  (o || ((i = I({}, i)), (u = I({}, u))), (u.stroke = ws(l))),
                (i.style = u);
            }
          }
          if (i && null == i.z2) {
      ...
      if ("blur" === t)
        return (function (t, e, n) {
          ...
          return (
            null == a.opacity &&
              ((n = I({}, n)),
              (a = I({ opacity: i ? r : 0.1 * o.opacity }, a)),
              (n.style = a)),
            n
          );
        })(this, t, n);
  ...
  function Os(t) {
    ...
    e && (e.stateProxy = Ps), n && (n.stateProxy = Ps);
  }
  function Rs(t, e) {
    !Hs(t, e) && !t.__highByOuter && As(t, Ss);
  }
  function Ns(t, e) {
    !Hs(t, e) && !t.__highByOuter && As(t, Ms);
  }
  function Es(t, e) {
    (t.__highByOuter |= 1 << (e || 0)), As(t, Ss);
  }
  function zs(t, e) {
    !(t.__highByOuter &= ~(1 << (e || 0))) && As(t, Ms);
  }
  function Bs(t) {
    As(t, Cs);
  }
  ...
  function Qs(t, e, n, i) {
    ...
    for (var r = 0; r < Ks.length; r++) {
      var o = Ks[r],
        a = e.getModel([o, n]);
      t.ensureState(o).style = i ? i(a) : a[$s[n]]();
    }
  }
  function Js(t, e) {
    var n = !1 === e,
  ...
  function pl(t, e) {
    return (t[0] * e[0] + t[1] * e[1]) / (cl(t) * cl(e));
  }
  function fl(t, e) {
    return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(pl(t, e));
  }
  function dl(t, e, n, i, r, o, a, s, l, u, h) {
    var c = l * (hl / 180),
      p = (ul(c) * (t - n)) / 2 + (ll(c) * (e - i)) / 2,
      f = (-1 * ll(c) * (t - n)) / 2 + (ul(c) * (e - i)) / 2,
      d = (p * p) / (a * a) + (f * f) / (s * s);
    d > 1 && ((a *= sl(d)), (s *= sl(d)));
    var g =
        (r === o ? -1 : 1) *
      ...
      y = (g * a * f) / s,
      v = (g * -s * p) / a,
      m = (t + n) / 2 + ul(c) * y - ll(c) * v,
      _ = (e + i) / 2 + ll(c) * y + ul(c) * v,
      x = fl([1, 0], [(p - y) / a, (f - v) / s]),
      w = [(p - y) / a, (f - v) / s],
      b = [(-1 * p - y) / a, (-1 * f - v) / s],
      S = fl(w, b);
    if ((pl(w, b) <= -1 && (S = hl), pl(w, b) >= 1 && (S = 0), S < 0)) {
      var M = Math.round((S / hl) * 1e6) / 1e6;
      S = 2 * hl + (M % 2) * hl;
    }
    h.addData(u, m, _, a, s, x, S, c, o);
  }
  var gl = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi,
    yl = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g;
  var vl = (function (t) {
    function e() {
      return (null !== t && t.apply(this, arguments)) || this;
            ...
            for (r = 0, o = 0; r < u; ) {
              switch (((n = l[r++]), (o = r), (i = 0), n)) {
                ...
                case d:
                  var y = e[4],
                    v = e[5],
                    m = ol(e[0] * e[0] + e[1] * e[1]),
                    _ = ol(e[2] * e[2] + e[3] * e[3]),
                    x = al(-e[1] / _, e[0] / m);
                  (l[r] *= m),
                    (l[r++] += y),
                    (l[r] *= _),
  ...
  function El(t, e) {
    ...
    if (o || r > 0) {
      ...
      if (!isNaN(s) && !isNaN(l)) {
        ...
        if ((f > Rl && (p = f), i > Rl))
          if (p > Tl - Rl)
            t.moveTo(u + i * Il(s), h + i * Cl(s)),
              t.arc(u, h, i, s, l, !c),
              r > Rl &&
                (t.moveTo(u + r * Il(l), h + r * Cl(l)),
                t.arc(u, h, r, l, s, c));
          else {
            var d = void 0,
              g = void 0,
                  ...
                  var B = A - z[0],
                    ...
                    G =
                      ...
                      Cl(
                        Dl(
                          (B * V + F * W) /
                            (Ll(B * B + F * F) * Ll(V * V + W * W)),
                        ) / 2,
                      ),
                    U = Ll(z[0] * z[0] + z[1] * z[1]);
                  (M = Ol(b, (i - U) / (G + 1))),
                    (T = Ol(S, (r - U) / (G - 1)));
                }
              }
                  ...
                  M < b && X === Y
                    ...
                    : (X > 0 &&
                      ...
                      t.arc(
                        ...
                        h,
                        i,
                        kl(q.cy + q.y1, q.cx + q.x1),
                        kl(Z.cy + Z.y1, Z.cx + Z.x1),
                        !c,
                      ),
                      Y > 0 &&
                        t.arc(
  ...
  function $l(t, e, n) {
    ...
    return null != i || null != r
      ? [
          (n ? sn : an)(t.x1, t.cpx1, t.cpx2, t.x2, e),
          (n ? sn : an)(t.y1, t.cpy1, t.cpy2, t.y2, e),
        ]
      : [
          (n ? fn : pn)(t.x1, t.cpx1, t.x2, e),
          (n ? fn : pn)(t.y1, t.cpy1, t.y2, e),
        ];
  }
  var Ql = (function (t) {
    function e(e) {
    ...
    return (
      ...
      (e.prototype.pointAt = function (t) {
        return $l(this.shape, t, !1);
      }),
      (e.prototype.tangentAt = function (t) {
        var e = $l(this.shape, t, !0);
        return At(e, e);
      }),
      e
    );
  })(Na);
  Ql.prototype.type = "bezier-curve";
  var Jl = function () {
      (this.cx = 0),
        (this.cy = 0),
        (this.r = 0),
  ...
  var eu = (function (t) {
      ...
      return (
        ...
        (e.prototype.getBoundingRect = function () {
          return (
            ...
            Na.prototype.getBoundingRect.call(this)
          );
        }),
        e
      );
    ...
    uu = (function () {
      function t(t, e) {
        ...
        for (var n = 0; n < 4; n++) this._corners[n] = new ye();
      ...
      return (
        ...
        (t.prototype.intersect = function (t, e) {
          ...
          return (
            su.set(1 / 0, 1 / 0),
            lu.set(0, 0),
            (!this._intersectCheckOneSide(this, t, su, lu, i, 1) &&
              ((n = !1), i)) ||
              (!this._intersectCheckOneSide(t, this, su, lu, i, -1) &&
                ((n = !1), i)) ||
              i ||
              ye.copy(e, n ? su : lu),
            n
        ...
        (t.prototype._intersectCheckOneSide = function (t, e, n, i, r, o) {
          for (var a = !0, s = 0; s < 2; s++) {
            var l = this._axes[s];
            if (
              (this._getProjMinMaxOnAxis(s, t._corners, ou),
              this._getProjMinMaxOnAxis(s, e._corners, au),
              ou[1] < au[0] || ou[0] > au[1])
            ) {
              if (((a = !1), r)) return a;
              var u = Math.abs(au[0] - ou[1]),
                h = Math.abs(ou[0] - au[1]);
              Math.min(u, h) > i.len() &&
                (u < h ? ye.scale(i, l, -u * o) : ye.scale(i, l, h * o));
            } else if (n) {
              (u = Math.abs(au[0] - ou[1])), (h = Math.abs(ou[0] - au[1]));
              Math.min(u, h) < n.len() &&
                (u < h ? ye.scale(n, l, u * o) : ye.scale(n, l, -h * o));
            }
          }
          return a;
        }),
    ...
    cu = (function (t) {
      ...
      return (
        ...
        (e.prototype.getBoundingRect = function () {
          if (!this._rect) {
            for (
              var t = new Te(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0;
              ...
              n.needLocalTransform() &&
                i.applyTransform(n.getLocalTransform(hu)),
                t.union(i);
            }
            this._rect = t;
          }
  ...
  function du(t, e, n, i, r, o) {
    fu("update", t, e, n, i, r, o);
  }
  function gu(t, e, n, i, r, o) {
    fu("enter", t, e, n, i, r, o);
  }
  function yu(t) {
    if (!t.__zr) return !0;
  ...
  function vu(t, e, n, i, r, o) {
    yu(t) || fu("leave", t, e, n, i, r, o);
  }
  function mu(t, e, n, i) {
    t.removeTextContent(),
      t.removeTextGuideLine(),
      vu(t, { style: { opacity: 0 } }, e, n, i);
  }
  function _u(t, e, n) {
    function i() {
    ...
    t.isGroup
      ? t.traverse(function (t) {
          t.isGroup || mu(t, e, n, i);
        })
      : mu(t, e, n, i);
  }
  function xu(t) {
    pu(t).oldStyle = t.style;
  }
  var wu = Math.max,
    bu = Math.min,
    Su = {};
  ...
  function Cu(t, e, n, i) {
    var r = (function (t, e) {
      return new vl(_l(t, e));
    })(t, e);
    return (
      n && ("center" === i && (n = Du(n, r.getBoundingRect())), Au(r, n)), r
    );
  }
  function Iu(t, e, n) {
    var i = new Va({
  ...
  function Ru(t, e) {
    if (t)
      if (H(t)) for (var n = 0; n < t.length; n++) Ou(t[n], e);
      else Ou(t, e);
  }
  Tu("circle", wl),
    Tu("ellipse", Sl),
  ...
  function zu(t, e, n, i) {
    n = n || Nu;
    for (var r = t instanceof ja, o = !1, a = 0; a < fs.length; a++) {
      if ((p = e[fs[a]]) && p.getShallow("show")) {
        o = !0;
        break;
      }
    }
    ...
    if (o) {
      r ||
        (s || ((s = new ja()), t.setTextContent(s)),
        t.stateProxy && (s.stateProxy = t.stateProxy));
      var l = Eu(n, e),
        u = e.normal,
        h = !!u.getShallow("show"),
        c = Fu(u, i && i.normal, n, !1, !r);
      (c.text = l.normal), r || t.setTextConfig(Vu(u, n, !1));
      for (a = 0; a < ps.length; a++) {
        ...
        if ((p = e[f])) {
          ...
          if (
            (g !== h && (d.ignore = !g),
            (d.style = Fu(p, i && i[f], n, !0, !r)),
            (d.style.text = l[f]),
            !r)
          )
            t.ensureState(f).textConfig = Vu(p, n, !0);
        }
      }
  ...
  var Hu = [
    ...
    Wu = ["align", "lineHeight", "width", "height", "tag", "verticalAlign"],
    Gu = [
      "padding",
      "borderWidth",
      "borderRadius",
  ...
  function Uu(t, e, n, i, r, o, a, s) {
    ...
    for (var g = 0; g < Hu.length; g++) {
      var y = Hu[g];
      null != (m = et(e.getShallow(y), n[y])) && (t[y] = m);
    }
    for (g = 0; g < Wu.length; g++) {
      y = Wu[g];
    ...
    $u = (function () {
      ...
      return (
        (t.prototype.getTextColor = function (t) {
          var e = this.ecModel;
          return this.getShallow("color") || (!t && e ? e.get(Zu) : null);
        }),
        ...
        (t.prototype.getTextRect = function (t) {
          ...
          return Ku.useStyle(e), Ku.update(), Ku.getBoundingRect();
        }),
        t
      );
    })(),
  ...
  io(rh),
    (Yu = rh),
    (qu = ["__\0is_clz", oo++].join("_")),
    (Yu.prototype[qu] = !0),
    (Yu.isInstance = function (t) {
      return !(!t || !t[qu]);
    }),
    P(rh, th),
    P(rh, ih),
    P(rh, co),
    P(rh, $u);
  var oh = Math.round(10 * Math.random());
  function ah(t) {
    return [t || "", oh++].join("_");
  }
  var sh = "ZH",
    ...
    ph =
      ...
      (
        ...
        : uh;
  function fh(t, e) {
    (t = t.toUpperCase()), (ch[t] = new rh(e)), (hh[t] = e);
  }
  fh(lh, {
    time: {
      month: [
  ...
  var dh = 1e3,
    ...
    wh = {
      ...
      month: "{yyyy}-{MM}",
      day: xh,
      hour: "{yyyy}-{MM}-{dd} " + _h.hour,
      minute: "{yyyy}-{MM}-{dd} " + _h.minute,
      second: "{yyyy}-{MM}-{dd} " + _h.second,
      millisecond: _h.none,
    },
    bh = ["year", "month", "day", "hour", "minute", "second", "millisecond"],
    Sh = [
      "year",
      "half-year",
      "quarter",
  ...
  function Zh(t, e, n) {
    ...
    for (var r = e[0].$vars || [], o = 0; o < r.length; o++) {
      var a = Yh[o];
      t = t.replace(qh(a), qh(a, 0));
    }
    for (var s = 0; s < i; s++)
      for (var l = 0; l < r.length; l++) {
        var u = e[s][r[l]];
        t = t.replace(qh(Yh[l], s), n ? Kt(u) : u);
      }
    return t;
  }
  function jh(t, e) {
  ...
  var rc = qr(),
    oc = (function (t) {
      function e(e, n, i) {
        ...
        return (r.uid = ah("ec_cpt_model")), r;
      }
      return (
        n(e, t),
  ...
  ro(oc, rh),
    ...
    (function (t, e) {
      ...
      var e = [];
      R(oc.getClassesByMainType(t), function (t) {
  ...
  function Sc(t, e, n) {
    ...
    var s = (function () {
      for (var t = {}, i = {}, s = [], l = 0, u = Math.min(5, n); l < u; l++) {
        var h = Cc(e.data, o, e.seriesLayoutBy, a, e.startIndex, l);
        s.push(h);
        var c = h === xc;
        if (
          (c && null == t.v && l !== r && (t.v = l),
          (null == t.n || t.n === t.v || (!c && s[t.n] === xc)) && (t.n = l),
          p(t) && s[t.n] !== xc)
        )
          return t;
        c ||
          (h === _c && null == i.v && l !== r && (i.v = l),
  ...
  function Cc(t, e, n, i, r, o) {
    ...
    if (null != l) return "ordinal" === l ? mc : xc;
    if (e === cc) {
      var h = t;
      if (n === vc) {
    ...
    Oc = (function () {
      ...
      return (
        (t.prototype.getColorFromPalette = function (t, e, n) {
          var i = Nr(this.get("color", !0)),
            r = this.get("colorLayer", !0);
          return Nc(this, Lc, i, r, t, e, n);
        }),
  ...
  function Rc(t, e, n, i) {
    var r = Nr(t.get(["aria", "decal", "decals"]));
    return Nc(t, Pc, r, null, e, n, i);
  }
  ...
  var Ec = (function (t) {
    ...
    return (
      ...
      (e.prototype.init = function (t, e, n, i, r, o) {
        (i = i || {}),
          (this.option = null),
          (this._theme = new rh(i)),
          (this._locale = new rh(r)),
      ...
      (e.prototype.resetOption = function (t, e) {
        return this._resetOption(t, Fc(e));
      }),
      ...
      (e.prototype._mergeOption = function (t, e) {
        ...
        (wc(this).datasetMap = ft()),
          ...
          s &&
            s.each(function (t, e) {
              oc.hasClass(e) && !a.get(e) && (o.push(e), a.set(e, !0));
            }),
          oc.topologicalTravel(
            o,
            oc.getAllClassMainTypes(),
            function (e) {
              ...
              R(
                ...
                function (t, n) {
                  ...
                  if (r) {
                    var o = "series" === e,
                      a = oc.getClass(e, t.keyInfo.subType, !o);
                    if (!a) return;
                    if ("tooltip" === e) {
                      if (h) return void 0;
                      h = !0;
                    ...
                    if (i && i.constructor === a)
                      ...
                      var s = I({ componentIndex: n }, t.keyInfo);
                      I((i = new a(r, this, this, s)), s),
      ...
      (e.prototype.getOption = function () {
        ...
        return (
          R(t, function (e, n) {
            if (oc.hasClass(n)) {
              for (var i = Nr(e), r = i.length, o = !1, a = r - 1; a >= 0; a--)
                i[a] && !Xr(i[a]) ? (o = !0) : ((i[a] = null), !o && r--);
              (i.length = r), (t[n] = i);
            }
          }),
          delete t["\0_ec_inner"],
      ...
      (e.prototype.findComponents = function (t) {
        ...
        return (o = Bc(u, t)), t.filter ? z(o, t.filter) : o;
      }),
      ...
      (e.prototype.isSeriesFiltered = function (t) {
        return kc(this), null == this._seriesIndicesMap.get(t.componentIndex);
      }),
      ...
      (e.prototype.restoreData = function (t) {
        ...
        var e = this._componentsMap,
          n = [];
        e.each(function (t, e) {
          oc.hasClass(e) && n.push(e);
        }),
          oc.topologicalTravel(n, oc.getAllClassMainTypes(), function (n) {
  ...
  function Fc(t) {
    ...
    return (
      t &&
        R(Nr(t.replaceMerge), function (t) {
          e.set(t, !0);
        }),
    ...
    Xc = (function () {
      ...
      return (
        (t.prototype.setOption = function (t, e, n) {
          t &&
            (R(Nr(t.series), function (t) {
              t && t.data && Z(t.data) && lt(t.data);
            }),
            R(Nr(t.dataset), function (t) {
  ...
  function tp(t) {
    t && (Qc(t), Jc(t, "label"), t.emphasis && Jc(t.emphasis, "label"));
  }
  function ep(t) {
    return H(t) ? t : t ? [t] : [];
  }
  ...
  function ip(t, e) {
        ...
        (function (t) {
          if (Zc(t)) {
            Kc(t),
              ...
              t.emphasis &&
                (Jc(t.emphasis, "label"),
                Jc(t.emphasis, "upperLabel"),
                Jc(t.emphasis, "edgeLabel"));
            var e = t.markPoint;
            e && (Kc(e), tp(e));
            var n = t.markLine;
            n && (Kc(n), tp(n));
            ...
            if ("graph" === t.type) {
              ...
              if (o && !Z(o)) for (var a = 0; a < o.length; a++) tp(o[a]);
              R(t.categories, function (t) {
                Qc(t);
              });
            }
            if (r && !Z(r)) for (a = 0; a < r.length; a++) tp(r[a]);
            if ((e = t.markPoint) && e.data) {
              var s = e.data;
              for (a = 0; a < s.length; a++) tp(s[a]);
            }
            if ((n = t.markLine) && n.data) {
              var l = n.data;
              for (a = 0; a < l.length; a++)
                H(l[a]) ? (tp(l[a][0]), tp(l[a][1])) : tp(l[a]);
            }
            "gauge" === t.type
              ? (Jc(t, "axisLabel"), Jc(t, "title"), Jc(t, "detail"))
              : "treemap" === t.type
              ? ($c(t.breadcrumb, "itemStyle"),
                R(t.levels, function (t) {
                  Qc(t);
                }))
              : "tree" === t.type && Qc(t.leaves);
          }
        })(t);
    });
    var n = [
    ...
    e && n.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"),
      qc(n, function (e) {
        qc(ep(t[e]), function (t) {
          t && (Jc(t, "axisLabel"), Jc(t.axisPointer, "label"));
        });
      }),
      qc(ep(t.parallel), function (t) {
        var e = t && t.parallelAxisDefault;
        Jc(e, "axisLabel"), Jc(e && e.axisPointer, "label");
      }),
      qc(ep(t.calendar), function (t) {
        $c(t, "itemStyle"),
          Jc(t, "dayLabel"),
          Jc(t, "monthLabel"),
          Jc(t, "yearLabel");
      }),
      qc(ep(t.radar), function (t) {
        Jc(t, "name"),
          t.name &&
            null == t.axisName &&
      ...
      qc(ep(t.geo), function (t) {
        Zc(t) &&
          (tp(t),
          qc(ep(t.regions), function (t) {
            tp(t);
          }));
      }),
      qc(ep(t.timeline), function (t) {
        tp(t), $c(t, "label"), $c(t, "itemStyle"), $c(t, "controlStyle", !0);
        var e = t.data;
        H(e) &&
          R(e, function (t) {
            Y(t) && ($c(t, "label"), $c(t, "itemStyle"));
          });
      }),
      qc(ep(t.toolbox), function (t) {
        $c(t, "iconStyle"),
          qc(t.feature, function (t) {
            $c(t, "iconStyle");
          });
      }),
      Jc(np(t.axisPointer), "label"),
      Jc(np(t.tooltip).axisPointer, "label");
  }
  function rp(t) {
    t &&
      R(op, function (e) {
  ...
  function cp(t, e) {
    if (t)
      for (var n = 0; n < t.length; n++) e(t[n]), t[n] && cp(t[n].children, e);
  }
  function pp(t, e) {
    ip(t, e),
      (t.series = Nr(t.series)),
        ...
        if (Y(t)) {
          ...
          if ("line" === e) null != t.clipOverflow && (t.clip = t.clipOverflow);
            ...
            if (
              ...
              for (var n = 0; n < r.length; n++) up(r[n]);
            null != t.hoverOffset &&
              ((t.emphasis = t.emphasis || {}),
            ...
            if (
              (lp(t),
              lp(t.backgroundStyle),
              lp(t.emphasis),
              (r = t.data) && !Z(r))
            )
              for (n = 0; n < r.length; n++)
                "object" == typeof r[n] &&
                  (lp(r[n]), lp(r[n] && r[n].emphasis));
          } else if ("sunburst" === e) {
  ...
  var dp,
    ...
    _p = function (t) {
      (this.data = t.data || (t.sourceFormat === fc ? {} : [])),
        (this.sourceFormat = t.sourceFormat || gc),
        (this.seriesLayoutBy = t.seriesLayoutBy || yc),
      ...
      if (e)
        for (var n = 0; n < e.length; n++) {
          var i = e[n];
          null == i.type && Tc(this, n) === mc && (i.type = "ordinal");
        }
    };
  function xp(t) {
  ...
  function bp(t) {
    return new _p({ data: t, sourceFormat: Z(t) ? dc : hc });
  }
  function Sp(t) {
    var e = gc;
    if (Z(t)) e = dc;
  ...
  var Ip = (function () {
    ...
    kp =
      (((dp = {}).arrayRows_column = function (t, e, n, i) {
        return t[i + e];
      }),
      (dp.arrayRows_row = function (t, e, n, i, r) {
        i += e;
      ...
      (dp.objectRows = Dp),
      (dp.keyedColumns = function (t, e, n, i, r) {
  ...
  var Lp = function (t, e, n) {
    ...
    Pp =
      (((gp = {}).arrayRows_column = function (t, e, n) {
        return Math.max(0, t.length - e);
      }),
      (gp.arrayRows_row = function (t, e, n) {
        var i = t[0];
        return i ? Math.max(0, i.length - e) : 0;
      }),
      (gp.objectRows = Lp),
      (gp.keyedColumns = function (t, e, n) {
        var i = n[0].name;
        var r = t[i];
        return r ? r.length : 0;
      }),
  ...
  var Rp = function (t, e, n) {
    ...
    Np =
      (((yp = {}).arrayRows = Rp),
      (yp.objectRows = function (t, e, n) {
        return t[n];
      }),
      (yp.keyedColumns = Rp),
      (yp.original = function (t, e, n) {
        var i = Br(t);
      ...
      return (
        ...
        (t.prototype.getFormattedLabel = function (t, e, n, i, r, o) {
          ...
          return W(r)
            ...
            : G(r)
            ? Zh(r, s).replace(Fp, function (e, n) {
                var i = n.length,
                  r = n;
                "[" === r.charAt(0) &&
                  "]" === r.charAt(i - 1) &&
        ...
        (t.prototype._doProgress = function (t, e, n, i, r) {
          Gp.reset(e, n, i, r),
            ...
            this._callingProgress(
              { start: e, end: n, count: n - e, next: Gp.next },
              this.context,
            );
        }),
  ...
  function qp(t) {
    ...
    if (e === pc) {
      for (r = [], o = 0, a = n.length; o < a; o++) r.push(I({}, n[o]));
      return r;
    }
  }
  function Zp(t, e, n) {
  ...
  function $p(t, e, n, i) {
    ...
    var s = N(e, function (t) {
        return (function (t, e) {
          ...
          return (
            (n.getDimensionInfo = F(Zp, null, s, l)),
            (n.cloneAllDimensionInfo = F(jp, null, s)),
            n
          );
        })(t, a);
      }),
    ...
    return N(l, function (t, n) {
      var i,
        r = "";
      Y(t) || Pr(r), t.data || Pr(r), Qp(Sp(t.data)) || Pr(r);
      var o = e[0];
      if (o && 0 === n && !t.dimensions) {
        ...
        i = { seriesLayoutBy: yc, sourceHeader: 0, dimensions: t.dimensions };
      return wp(t.data, i, null);
    });
  }
  function Qp(t) {
    return t === cc || t === pc;
  ...
  var Jp,
    tf = "undefined",
    ef = typeof Uint32Array === tf ? Array : Uint32Array,
    nf = typeof Uint16Array === tf ? Array : Uint16Array,
    rf = typeof Int32Array === tf ? Array : Int32Array,
    of = typeof Float64Array === tf ? Array : Float64Array,
    af = { float: of, int: rf, ordinal: Array, number: Array, time: of };
  function sf(t) {
    return t > 65535 ? ef : nf;
  }
  ...
  var uf = (function () {
      ...
      return (
        (t.prototype.initData = function (t, e, n) {
          ...
          var i = t.getSource(),
            r = (this.defaultDimValueGetter = Jp[i.sourceFormat]);
        ...
        (t.prototype.ensureCalculationDimension = function (t, e) {
          ...
          return (
            (i[r] = { type: e }),
            n.set(t, r),
            (this._chunks[r] = new af[e || "float"](this._rawCount)),
        ...
        (t.prototype.appendValues = function (t, e) {
          for (
            ...
            lf(n, l, (f = i[l]).type, s, !0);
          }
          for (var u = [], h = a; h < s; h++)
            for (var c = h - a, p = 0; p < r; p++) {
              var f = i[p],
                d = Jp.arrayRows.call(this, t[c] || u, f.property, c, p);
              n[p][h] = d;
              var g = o[p];
        ...
        (t.prototype._initDataFromProvider = function (t, e, n) {
          for (
            ...
            var h = o[u];
            s[u] || (s[u] = [1 / 0, -1 / 0]), lf(r, u, h.type, e, n);
          }
        ...
        (t.prototype.getIndices = function () {
          ...
          if (e) {
            ...
            t = new (n = sf(this._rawCount))(this.count());
        ...
        (t.prototype.downSample = function (t, e, n, i) {
          for (
            var r = this.clone([t], !0),
              ...
              c = new (sf(this._rawCount))(Math.ceil(u / s)),
              p = 0,
              f = 0;
            f < u;
            f += s
        ...
        (t.internalField = (function () {
          function t(t, e, n, i) {
            return Up(t[i], this._dimensions[i]);
          }
          Jp = {
            arrayRows: t,
            objectRows: function (t, e, n, i) {
              return Up(t[e], this._dimensions[i]);
            },
            keyedColumns: t,
            original: function (t, e, n, i) {
              var r = t && (null == t.value ? t : t.value);
              return Up(r instanceof Array ? r[i] : r, this._dimensions[i]);
            },
      ...
      return (
          ...
          if (pf(n)) {
            ...
            if (r) {
              ...
              u.prepareSource(),
                ...
                (s = l.sourceFormat),
                (e = [u._getVersionSign()]);
            } else (s = Z((a = o.get("data", !0))) ? dc : hc), (e = []);
            ...
            if (r) {
              ...
              (t = [
                wp(g.get("source", !0), this._getSourceMetaRawOption(), null),
              ]),
                (e = []);
            }
          }
          ...
          return (
            R(t, function (t) {
              ...
              var e = t.getSource(r || 0),
                n = "";
              null == r || e || ff(n), s.push(e), l.push(t._getVersionSign());
            }),
            i
              ? (e = (function (t, e, n) {
                  var i = Nr(t),
        ...
        (t.prototype._innerGetDataStore = function (t, e, n) {
          ...
          if (!o) {
            ...
            pf(this._sourceHost) && a
              ? (o = a._innerGetDataStore(t, e, n))
              : (o = new uf()).initData(new Ip(e, t.length), t),
              (r[n] = o);
          }
          return o;
        }),
    ...
    return (
      ...
      (e.prototype.init = function (t, e, n) {
        (this.seriesIndex = this.componentIndex),
          (this.dataTask = Hp({ count: xf, reset: wf })),
          (this.dataTask.context = { model: this }),
          this.mergeDefaultAndTheme(t, n),
          (yf(this).sourceManager = new hf(this)).prepareSource();
      ...
      (e.prototype.formatTooltip = function (t, e, n) {
        return gf({ series: this, dataIndex: t, multipleSeries: e });
      }),
      ...
      (e.prototype.getColorFromPalette = function (t, e, n) {
        var i = this.ecModel,
          r = Oc.prototype.getColorFromPalette.call(this, t, e, n);
  ...
  function wf(t) {
    var e = t.model;
    return e.setData(e.getRawData().cloneShallow()), bf;
  }
  function bf(t, e) {
    e.outputData &&
  ...
  P(mf, Vp), P(mf, Oc), ro(mf, oc);
  var Cf = (function () {
    function t() {
      (this.group = new rr()), (this.uid = ah("viewComponent"));
    }
    return (
  ...
  var Df = qr(),
    ...
    Af = (function () {
      function t() {
        (this.group = new rr()),
          (this.uid = ah("viewChart")),
          (this.renderTask = Hp({ plan: Of, reset: Rf })),
    ...
    var i = Yr(t, e),
      r =
        e && null != e.highlightKey
          ? (function (t) {
              var e = us[t];
              return null == e && ls <= 32 && (e = us[t] = ls++), e;
            })(e.highlightKey)
          : null;
    null != i
      ? R(Nr(i), function (e) {
          Lf(t.getItemGraphicEl(e), n, r);
        })
  ...
  function Rf(t) {
    var e = t.model,
      ...
      a = t.view,
      s = r && Df(r).updateMethod,
      l = o ? "incrementalPrepareRender" : s && a[s] ? s : "render";
    return "render" !== l && a[l](e, n, i, r), Nf[l];
  }
  io(Af), lo(Af);
  var Nf = {
  ...
  var zf = qr(),
    Bf = { itemStyle: uo(eh, !0), lineStyle: uo(Qu, !0) },
    Ff = { lineStyle: "stroke", itemStyle: "fill" };
  function Vf(t, e) {
    var n = t.visualStyleMapper || Bf[e];
    return n || (console.warn("Unknown style type '" + e + "'."), Bf.itemStyle);
  }
  function Hf(t, e) {
    var n = t.visualDrawType || Ff[e];
            ...
            dataEach: n.hasItemOption
              ? function (t, e) {
                  ...
                  if (n && n[i]) {
                    Gf.option = n[i];
                    var a = r(Gf);
                    I(t.ensureUniqueItemVisual(e, "style"), a),
                      Gf.option.decal &&
                        (t.setItemVisual(e, "decal", Gf.option.decal),
                        (Gf.option.decal.dirty = !0)),
  ...
  var qf = (function () {
    ...
    return (
      ...
      (t.prototype._createSeriesStageTask = function (t, e, n, i) {
        ...
        function u(e) {
          var s = e.uid,
            l = a.set(
              s,
              (o && o.get(s)) || Hp({ plan: Qf, reset: Jf, count: nd }),
            );
          (l.context = {
            model: e,
            ecModel: n,
      ...
      (t.prototype._createOverallStageTask = function (t, e, n, i) {
        var r = this,
          o = (e.overallTask = e.overallTask || Hp({ reset: Zf }));
        o.context = {
          ecModel: n,
          api: i,
        ...
        function f(t) {
          var e = t.uid,
            n = s.set(
              e,
              (a && a.get(e)) || ((c = !0), Hp({ reset: jf, onDirty: $f })),
            );
      ...
      (t.wrapStageHandler = function (t, e) {
        return (
          W(t) && (t = { overallReset: t, seriesType: id(t) }),
          (t.uid = ah("stageHandler")),
          e && (t.visualType = e),
          t
        );
      }),
  ...
  sd(od, Ec),
    sd(ad, Hc),
    (od.eachSeriesByType = od.eachRawSeriesByType =
      function (t) {
        rd = t;
      }),
    (od.eachComponent = function (t) {
      "series" === t.mainType && t.subType && (rd = t.subType);
    });
  var ld = [
      "#37A2DA",
      "#32C5E9",
    ...
    dd = {
      ...
      legend: { textStyle: { color: hd } },
      textStyle: { color: hd },
      title: {
        textStyle: { color: "#EEF1FA" },
        subtextStyle: { color: "#B9B8CE" },
      },
      toolbox: { iconStyle: { borderColor: hd } },
      dataZoom: {
        borderColor: "#71708A",
        textStyle: { color: hd },
      ...
      visualMap: { textStyle: { color: hd } },
      timeline: {
        lineStyle: { color: hd },
        label: { color: hd },
        controlStyle: { color: hd, borderColor: hd },
      },
      calendar: {
        itemStyle: { color: cd },
        dayLabel: { color: hd },
  ...
  dd.categoryAxis.splitLine.show = !1;
  var gd = (function () {
      function t() {}
      return (
    ...
    yd = ["symbol", "symbolSize", "symbolRotate", "symbolOffset"],
    vd = yd.concat(["symbolKeepAspect"]),
    md = {
      createOnAllSeries: !0,
      performRawSeries: !0,
      reset: function (t, e) {
        ...
        if (
          ...
          for (var i = {}, r = {}, o = !1, a = 0; a < yd.length; a++) {
            var s = yd[a],
              l = t.get(s);
            W(l) ? ((o = !0), (r[s] = l)) : (i[s] = l);
          }
        ...
        if (t.hasSymbolVisual && !e.isSeriesFiltered(t))
          return {
            dataEach: t.getData().hasItemOption
              ? function (t, e) {
                  for (var n = t.getItemModel(e), i = 0; i < vd.length; i++) {
                    var r = vd[i],
                      o = n.getShallow(r, !0);
  ...
  var bd = Math.round(9 * Math.random()),
    Sd = "function" == typeof Object.defineProperty,
    Md = (function () {
      function t() {
  ...
  var Ld = Na.extend({
    ...
    buildPath: function (t, e, n) {
      ...
      if ("none" !== i) {
        var r = Ad[i];
        r || (r = Ad[(i = "rect")]),
          kd[i](e.x, e.y, e.width, e.height, r.shape),
  ...
  function Od(t, e, n, i, r, o, a) {
    ...
    return (
      ...
      ((s =
        0 === t.indexOf("image://")
          ? Iu(t.slice(8), new Te(e, n, i, r), a ? "center" : "cover")
          : 0 === t.indexOf("path://")
          ? Cu(t.slice(7), {}, new Te(e, n, i, r), a ? "center" : "cover")
          : new Ld({
  ...
  function Rd(t, e) {
    if (null != t)
      return (
        H(t) || (t = [t, t]),
        [fr(t[0], e[0]) || 0, fr(et(t[1], t[0]), e[1]) || 0]
      );
  }
  function Nd(t) {
    return isFinite(t);
  ...
  function jd(t, e, n, i, r) {
    ...
    if (i || e.opacity !== n.opacity) {
      ...
      t.globalAlpha = isNaN(a) ? Lo.opacity : a;
    }
    (i || e.blend !== n.blend) &&
      (o || (Qd(t, r), (o = !0)),
      (t.globalCompositeOperation = e.blend || Lo.blend));
    for (var s = 0; s < qd.length; s++) {
      var l = qd[s];
      (i || e[l] !== n[l]) &&
        (o || (Qd(t, r), (o = !0)), (t[l] = t.dpr * (e[l] || 0)));
    }
    return (
      (i || e.shadowColor !== n.shadowColor) &&
        (o || (Qd(t, r), (o = !0)),
        (t.shadowColor = e.shadowColor || Lo.shadowColor)),
      o
    );
  }
  function Kd(t, e, n, i, r) {
    var o = Jd(e, r.inHover),
      a = i ? null : (n && Jd(n, r.inHover)) || {};
    if (o === a) return !1;
    var s = jd(t, o, a, i, r);
    if (
      ((i || o.fill !== a.fill) &&
        (s || (Qd(t, r), (s = !0)), Wd(o.fill) && (t.fillStyle = o.fill)),
      (i || o.stroke !== a.stroke) &&
        (s || (Qd(t, r), (s = !0)), Wd(o.stroke) && (t.strokeStyle = o.stroke)),
      ...
      t.lineWidth !== l && (s || (Qd(t, r), (s = !0)), (t.lineWidth = l));
    }
    for (var u = 0; u < Zd.length; u++) {
      var h = Zd[u],
        c = h[0];
      (i || o[c] !== a[c]) &&
        (s || (Qd(t, r), (s = !0)), (t[c] = o[c] || h[1]));
    }
    return s;
  }
  function $d(t, e) {
  ...
  function tg(t, e) {
    eg(t, e, { inHover: !1, viewWidth: 0, viewHeight: 0 }, !0);
  }
  function eg(t, e, n, i) {
    var r = e.transform;
    ...
    if (
      ...
      e instanceof Na
          ...
          (function (t, e, n, i) {
            ...
            if (!i) {
              ...
              (d || g) && (b = e.getBoundingRect()),
                d &&
                  ((m = c ? Ed(t, p, b) : e.__canvasFillGradient),
                  (e.__canvasFillGradient = m)),
                g &&
                  ((_ = c ? Ed(t, f, b) : e.__canvasStrokeGradient),
            ...
            h.setScale(T[0], T[1], e.segmentIgnoreThreshold),
              t.setLineDash && n.lineDash && ((S = (r = Fd(e))[0]), (M = r[1]));
            var C = !0;
            (u || 4 & c) &&
              (h.setDPR(t.dpr),
        ...
        ? (3 !== n.lastDrawType && ((u = !0), (n.lastDrawType = 3)),
          ...
          (function (t, e, n) {
            ...
            if ((null != r && (r += ""), r)) {
              ...
              var a = void 0,
                s = void 0;
              t.setLineDash && n.lineDash && ((a = (i = Fd(e))[0]), (s = i[1])),
                a && (t.setLineDash(a), (t.lineDashOffset = s)),
                n.strokeFirst
                  ? (Hd(n) && t.strokeText(r, n.x, n.y),
                    Gd(n) && t.fillText(r, n.x, n.y))
                  : (Gd(n) && t.fillText(r, n.x, n.y),
                    Hd(n) && t.strokeText(r, n.x, n.y)),
                a && t.setLineDash([]);
            }
        ...
        ? (2 !== n.lastDrawType && ((u = !0), (n.lastDrawType = 2)),
          (function (t, e, n, i, r) {
            jd(t, Jd(e, r.inHover), n && Jd(n, r.inHover), i, r);
          })(t, e, h, u, n),
          (function (t, e, n) {
  ...
  function og(t, e) {
    ...
    return (
      (function (t) {
        for (var e, o = [n], s = !0, l = 0; l < rg.length; ++l) {
          var h = a[rg[l]];
        ...
        var p,
          ...
          x = (function () {
            for (var t = 1, e = 0, n = y.length; e < n; ++e) t = Ar(t, y[e]);
            var i = 1;
            for (e = 0, n = g.length; e < n; ++e) i = Ar(i, g[e].length);
            t *= i;
  ...
  var pg = 2e3,
    ...
    gg = /^[a-zA-Z0-9_]+$/,
    yg = "__connectUpdateStatus";
  function vg(t) {
    return function () {
      for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
      if (!this.isDisposed()) return _g(this, t, e);
      Gg(this.id);
    };
  }
  function mg(t) {
  ...
  var xg,
    ...
    Fg = Bg.prototype;
  (Fg.on = mg("on")), (Fg.off = mg("off"));
  var Vg = (function (t) {
      function e(e, n, i) {
        var r = t.call(this, new gd()) || this;
        (r._chartsViews = []),
          (r._chartsMap = {}),
          (r._componentsViews = []),
          (r._componentsMap = {}),
        ...
        (r._ssr = i.ssr),
          (r._throttledZrFlush = Ef(F(l.flush, l), 17)),
          (n = T(n)) && pp(n, !0),
          (r._theme = n),
          (r._locale = (function (t) {
            if (G(t)) {
              var e = hh[t.toUpperCase()] || {};
              return t === sh || t === lh ? T(e) : C(T(e), T(hh.EN), !1);
            }
            return C(T(t), T(hh.EN), !1);
          })(i.locale || ph)),
          (r._coordSysMgr = new Gc());
        var u = (r._api = Rg(r));
        function h(t, e) {
        ...
        return (
          He(Zg, h),
          He(Yg, h),
          (r._scheduler = new qf(r, u, Yg, Zg)),
          (r._messageCenter = new Bg()),
          r._initEvents(),
      ...
      return (
        ...
        (e.prototype._onframe = function () {
          if (!this._disposed) {
            ...
            if (this.__pendingUpdate) {
              ...
              try {
                xg(this),
                  Sg.update.call(this, null, this.__pendingUpdate.updateParams);
              } catch (t) {
                throw (
          ...
          if (!this.__flagInMainProcess)
            if (this._disposed) Gg(this.id);
              ...
              if (
                ...
                var a = new Xc(this._api),
                  s = this._theme,
                  l = (this._model = new Ec());
              ...
              if (n)
                ...
                try {
                  xg(this), Sg.update.call(this, null, u);
                } catch (t) {
                  throw (
                    ((this.__pendingUpdate = null),
                    (this.__flagInMainProcess = !1),
        ...
        (e.prototype.convertToPixel = function (t, e) {
          return Mg(this, "convertToPixel", t, e);
        }),
        (e.prototype.convertFromPixel = function (t, e) {
          return Mg(this, "convertFromPixel", t, e);
        }),
        ...
        (e.prototype.getVisual = function (t, e) {
          var n = jr(this._model, t, { defaultMainType: "series" }),
            i = n.seriesModel;
          var r = i.getData(),
        ...
        (e.prototype._initEvents = function () {
          ...
          R(Wg, function (t) {
                  ...
                  : o &&
                    wd(
                      ...
                      function (t) {
                        ...
                        if (e.eventData) return (n = I({}, e.eventData)), !0;
                      },
                      !0,
                    ),
                n)
            ...
            t.on("selectchanged", function (t) {
              var i = n.getModel();
              t.isFromClick
                ? (xd("map", "selectchanged", e, i, t),
                  xd("pie", "selectchanged", e, i, t))
                : "select" === t.fromAction
                ? (xd("map", "selected", e, i, t),
                  xd("pie", "selected", e, i, t))
                : "unselect" === t.fromAction &&
                  (xd("map", "unselected", e, i, t),
                  xd("pie", "unselected", e, i, t));
            });
        }),
        ...
        (e.prototype.clear = function () {
          this._disposed ? Gg(this.id) : this.setOption({ series: [] }, !0);
        }),
        (e.prototype.dispose = function () {
          if (this._disposed) Gg(this.id);
          else {
            (this._disposed = !0), this.getDom() && Jr(this.getDom(), ey, "");
            var t = this,
              e = t._api,
              n = t._model;
              ...
              if ((this._loadingFX && this._loadingFX.resize(), e)) {
                ...
                try {
                  n && xg(this),
                    Sg.update.call(this, {
                      type: "resize",
                      animation: I({ duration: 0 }, t && t.animation),
                    });
                } catch (t) {
                  throw ((this.__flagInMainProcess = !1), t);
                }
                (this.__flagInMainProcess = !1),
                  Ig.call(this, i),
                  Dg.call(this, i);
        ...
        (e.prototype.makeActionFromEvent = function (t) {
          var e = I({}, t);
          return (e.type = Xg[t.type]), e;
        }),
        (e.prototype.dispatchAction = function (t, e) {
          if (this._disposed) Gg(this.id);
          else if ((Y(e) || (e = { silent: !!e }), Ug[t.type] && this._model))
        ...
        (e.prototype.updateLabelLayout = function () {
          ug.trigger("series:layoutlabels", this._model, this._api, {
            updatedSeries: [],
          });
        }),
        (e.prototype.appendData = function (t) {
          ...
          (xg = function (t) {
            ...
            (wg = function (t, e) {
              ...
              function u(t) {
                ...
                if (!h) {
                  var c = no(t.type),
                    p = e ? Cf.getClass(c.main, c.sub) : Af.getClass(c.sub);
                  0,
                    (h = new p()).init(n, s),
                    (o[u] = h),
                    r.push(h),
                          ...
                          if (nl(n))
                            if (e instanceof mf)
                              ...
                              n.type === ds &&
                                r &&
                                !n.notBlur &&
                                Us(e.mainType, e.componentIndex, t._api),
                                o &&
                                  R(o, function (t) {
                                    n.type === ds ? Es(t) : zs(t);
                                  });
            ...
            (Sg = {
              ...
              updateView: function (e) {
                ...
                n &&
                  ...
                  Af.markUpdateMethod(e, "updateView"),
                  t(n),
                  this._scheduler.performVisualTasks(n, e, { setDirty: !0 }),
                  Lg(this, n, this._api, e, {}),
                  ug.trigger("afterupdate", n, this._api));
              },
              updateVisual: function (e) {
                ...
                i &&
                  ...
                  Af.markUpdateMethod(e, "updateVisual"),
                  t(i),
                  this._scheduler.performVisualTasks(i, e, {
                    visualType: "visual",
                    setDirty: !0,
                  ...
                  ug.trigger("afterupdate", i, this._api));
              },
            ...
            (Cg = function (t, e) {
              ...
              if (
                ...
                R(c, function (e) {
                  if (
                    (((f =
                      (f = a.action(e, n._model, n._api)) || I({}, e)).type =
                      s.event || f.type),
                    d.push(f),
                    y)
                  ) {
                    ...
                    g
                      ? (bg(n, u, e, "series"), Eg(n))
                      : h && bg(n, u, e, h.main, h.sub);
                }),
                "none" !== u && !y && !g && !h)
              )
                try {
                ...
                n &&
                  (!(function (t, e, n) {
                    var i = ss(t),
                      ...
                      a = r.focusSelf;
                    o
                      ? (a && Us(i.componentMainType, i.componentIndex, n),
                        R(o, function (t) {
                          return Rs(t, e);
                        }))
                      : (Gs(i.seriesIndex, i.focus, i.blurScope, n),
                        "self" === i.focus &&
                          Us(i.componentMainType, i.componentIndex, n),
                        Rs(t, e));
                  })(n, t, e._api),
                  Eg(e));
              })
            ...
            (Pg = function (t, e, n, r, o, l) {
              R(l || t._componentsViews, function (t) {
                var o = t.__model;
                a(o, t), t.render(o, e, n, r), i(o, t), s(o, t);
              });
            }),
            (Og = function (t, e, n, o, l, u) {
              var h = t._scheduler;
              (l = I(l || {}, { updatedSeries: e.getSeries() })),
                ug.trigger("series:beforeupdate", e, n, l);
              var c = !1;
              e.eachSeries(function (e) {
                ...
                ug.trigger("series:layoutlabels", e, n, l),
                ug.trigger("series:transition", e, n, l),
                e.eachSeries(function (e) {
                  var n = t._chartsMap[e.__viewId];
                  i(e, n), s(e, n);
                }),
                ...
                ug.trigger("series:afterupdate", e, n, l);
            }),
            (Eg = function (t) {
              (t.__needsUpdateStatus = !0), t.getZr().wakeUp();
            }),
            (zg = function (t) {
              t.__needsUpdateStatus &&
  ...
  function cy(t, e, n) {
    ...
    (t.event = (t.event || i).toLowerCase()),
      (e = t.event),
      Xg[e] ||
        (ot(gg.test(i) && gg.test(e)),
        Ug[i] || (Ug[i] = { action: n, actionInfo: t }),
        (Xg[e] = i));
  }
  function py(t, e) {
    Gc.register(t, e);
  ...
  function fy(t, e) {
    yy(Zg, t, e, 1e3, "layout");
  }
  function dy(t, e) {
    yy(Zg, t, e, 3e3, "visual");
  }
  var gy = [];
  function yy(t, e, n, i, r) {
    if (((W(e) || Y(e)) && ((n = e), (e = i)), !(A(gy, n) >= 0))) {
      gy.push(n);
  ...
  dy(pg, Wf),
        ...
        if (!t.isSeriesFiltered(n)) {
          ...
          i.hasItemVisual() &&
            i.each(function (t) {
              ...
              n && (i.ensureUniqueItemVisual(t, "style").decal = og(n, e));
            });
          var r = i.getVisual("decal");
          if (r) i.getVisual("style").decal = og(r, e);
        }
      });
    }),
    ay(pp),
    ...
    vy("default", function (t, e) {
      ...
      var n = new rr(),
        i = new Ya({ style: { fill: e.maskColor }, zlevel: e.zlevel, z: 1e4 });
      n.add(i);
      var r,
        o = new ja({
          style: {
      ...
      return (
        ...
        e.showSpinner &&
          ((r = new tu({
            ...
            .animateShape(!0)
            .when(1e3, { endAngle: (3 * Yf) / 2 })
            .start("circularInOut"),
          r
            .animateShape(!0)
            .when(1e3, { startAngle: (3 * Yf) / 2 })
            .delay(300)
            .start("circularInOut"),
          n.add(r)),
        (n.resize = function () {
    ...
    cy({ type: ds, event: ds, update: ds }, mt),
    cy({ type: gs, event: gs, update: gs }, mt),
    cy({ type: ys, event: ys, update: ys }, mt),
    cy({ type: vs, event: vs, update: vs }, mt),
    cy({ type: ms, event: ms, update: ms }, mt),
    oy("light", ud),
    oy("dark", dd);
  var xy = [],
    wy = {
      registerPreprocessor: ay,
      registerProcessor: sy,
      registerPostInit: ly,
      registerPostUpdate: uy,
      registerUpdateLifecycle: hy,
      registerAction: cy,
      registerCoordinateSystem: py,
      registerLayout: fy,
      registerVisual: dy,
      registerTransform: _y,
      registerLoading: vy,
      registerMap: my,
      ...
      registerSubTypeDefaulter: function (t, e) {
        oc.registerSubTypeDefaulter(t, e);
      },
  ...
  function by(t) {
    H(t)
      ...
      : A(xy, t) >= 0 ||
        (xy.push(t), W(t) && (t = { install: t }), t.install(wy));
  }
  function Sy(t) {
  ...
  var Ty = (function () {
      function t(t, e, n, i, r, o) {
        (this._old = t),
          (this._new = e),
          (this._oldKeyGetter = n || My),
          (this._newKeyGetter = i || My),
          (this.context = r),
  ...
  var Dy = function (t) {
      (this.otherDims = {}), null != t && I(this, t);
    },
    ky = qr(),
    Ay = { float: "f", int: "i", ordinal: "o", number: "n", time: "t" },
    Ly = (function () {
      function t(t) {
      ...
      return (
        ...
        (t.prototype._updateDimOmitted = function (t) {
          (this._dimOmitted = t),
            t && (this._dimNameMap || (this._dimNameMap = Ry(this.source)));
        }),
  ...
  function Ry(t) {
    var e = ky(t);
    return e.dimNameMap || (e.dimNameMap = Oy(t.dimensionsDefine));
  }
  function Ny(t) {
    return t > 30;
  }
  var Ey,
    ...
    Gy = Y,
    Uy = N,
    Xy = "undefined" == typeof Int32Array ? Array : Int32Array,
    Yy = [
      "hasItemOption",
      "_nameList",
      "_idList",
    ...
    Zy = (function () {
      function t(t, e) {
        ...
        for (
          ...
          var h = n[u],
            c = G(h) ? new Dy({ name: h }) : h instanceof Dy ? h : new Dy(h),
            p = c.name;
          (c.type = c.type || "float"),
      ...
      return (
        ...
        (t.prototype.initData = function (t, e, n) {
          var i,
            r = this;
          if ((t instanceof uf && (i = t), !i)) {
            var o = this.dimensions,
              a = xp(t) || O(t) ? new Ip(t, o.length) : t;
            i = new uf();
            var s = Uy(o, function (t) {
                ...
                if (u) {
                  ...
                  (Iy(i, u)[h] = e),
                    l.isExtraCoord ||
                      ...
                      (Iy(s, u)[h] = t.getDimensionIndex(l.name))),
                    l.defaultTooltip && a.push(e);
                }
                uc.each(function (t, e) {
                  var n = Iy(i, e),
                    r = l.otherDims[e];
        ...
        (t.prototype.appendValues = function (t, e) {
          ...
          if ((this._updateOrdinalMeta(), e))
            for (var a = i; a < r; a++) {
              var s = a - i;
              (this._nameList[a] = e[s]), o && Wy(this, a);
            }
        }),
        ...
        (t.prototype._doInit = function (t, e) {
          if (!(t >= e)) {
            ...
            var i = this._nameList,
              r = this._idList;
            if (n.getSource().sourceFormat === hc && !n.pure)
              for (var o = [], a = t; a < e; a++) {
                var s = n.getItem(a, o);
                if (
                  (!this.hasItemOption && Fr(s) && (this.hasItemOption = !0), s)
                ) {
                  var l = s.name;
                  null == i[a] && null != l && (i[a] = Gr(l, null));
                  var u = s.id;
                  null == r[a] && null != u && (r[a] = Gr(u, null));
                }
              }
            if (this._shouldMakeIdFromName())
              for (a = t; a < e; a++) Wy(this, a);
            Ey(this);
          }
        }),
        ...
        (t.prototype.setCalculationInfo = function (t, e) {
          Gy(t) ? I(this._calculationInfo, t) : (this._calculationInfo[t] = e);
        }),
        ...
        (t.prototype.getId = function (t) {
          return zy(this, this.getRawIndex(t));
        }),
        (t.prototype.count = function () {
        ...
        (t.prototype.each = function (t, e, n) {
          W(t) && ((n = e), (e = t), (t = []));
          var i = n || this,
            r = Uy(Fy(t), this._getStoreDimIndex, this);
        ...
        (t.prototype.setVisual = function (t, e) {
          (this._visual = this._visual || {}),
            Gy(t) ? I(this._visual, t) : (this._visual[t] = e);
        }),
        ...
        (t.prototype.setItemVisual = function (t, e, n) {
          ...
          (this._itemVisuals[t] = i), Gy(e) ? I(i, e) : (i[e] = n);
        }),
        (t.prototype.clearAllVisual = function () {
          (this._visual = {}), (this._itemVisuals = []);
        }),
        (t.prototype.setLayout = function (t, e) {
          Gy(t) ? I(this._layout, t) : (this._layout[t] = e);
        }),
        ...
        (t.prototype.setItemLayout = function (t, e, n) {
          this._itemLayouts[t] = n ? I(this._itemLayouts[t] || {}, e) : e;
        }),
          ...
          return (
            e ||
              (e = new t(
                this._schema
                  ? this._schema
                  : Uy(this.dimensions, this._getDimInfo, this),
                this.hostModel,
              )),
            Vy(e, this),
        ...
        (t.internalField =
          ((Ey = function (t) {
            ...
            R(e, function (n, i) {
              var r = t._dimInfos[i],
                ...
                a = t._store;
              if (o) {
                n = e[i] = new Xy(o.categories.length);
          ...
          (By = function (t, e, n) {
            return Gr(t._getCategory(e, n), null);
          }),
          (zy = function (t, e) {
            var n = t._idList[e];
            return (
              null == n && null != t._idDimIdx && (n = By(t, t._idDimIdx, e)),
              null == n && (n = "e\0\0" + e),
              n
            );
          }),
          ...
          (Hy = function (e) {
            var n = new t(
              e._schema ? e._schema : Uy(e.dimensions, e._getDimInfo, e),
              e.hostModel,
            );
            return Vy(n, e), n;
          }),
          (Vy = function (t, e) {
            R(Yy.concat(e.__wrappedMethods || []), function (n) {
              e.hasOwnProperty(n) && (t[n] = e[n]);
            }),
              ...
              (t._calculationInfo = I({}, e._calculationInfo));
          }),
          void (Wy = function (t, e) {
            var n = t._nameList,
              i = t._idList,
              r = t._nameDimIdx,
              o = t._idDimIdx,
              ...
              s = i[e];
            if (
              (null == a && null != r && (n[e] = a = By(t, r, e)),
              null == s && null != o && (i[e] = s = By(t, o, e)),
              null == s && null != a)
            ) {
  ...
  function jy(t, e) {
    ...
    var n = (e = e || {}).coordDimensions || [],
      ...
      s = e.canOmitUnusedDimensions && Ny(a),
      l = i === t.dimensionsDefine,
      u = l ? Ry(t) : Oy(i),
      h = e.encodeDefine;
    !h && e.encodeDefaulter && (h = e.encodeDefaulter(t, a));
    for (var c = ft(h), p = new rf(a), f = 0; f < p.length; f++) p[f] = -1;
    function d(t) {
      var e = p[t];
      if (e < 0) {
        var n = i[t],
  ...
  var Qy = {
    cartesian2d: function (t, e, n, i) {
      var r = t.getReferringComponents("xAxis", $r).models[0],
        o = t.getReferringComponents("yAxis", $r).models[0];
      (e.coordSysDims = ["x", "y"]),
        n.set("x", r),
        n.set("y", o),
        Jy(r) && (i.set("x", r), (e.firstCategoryDimIndex = 0)),
        Jy(o) &&
          (i.set("y", o),
          null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1));
    },
    singleAxis: function (t, e, n, i) {
      var r = t.getReferringComponents("singleAxis", $r).models[0];
      (e.coordSysDims = ["single"]),
        n.set("single", r),
        Jy(r) && (i.set("single", r), (e.firstCategoryDimIndex = 0));
    },
    polar: function (t, e, n, i) {
      var r = t.getReferringComponents("polar", $r).models[0],
        o = r.findAxisModel("radiusAxis"),
        a = r.findAxisModel("angleAxis");
      (e.coordSysDims = ["radius", "angle"]),
        n.set("radius", o),
        n.set("angle", a),
        Jy(o) && (i.set("radius", o), (e.firstCategoryDimIndex = 0)),
        Jy(a) &&
          (i.set("angle", a),
          null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1));
    },
  ...
  function nv(t, e) {
    return ev(t, e) ? t.getCalculationInfo("stackResultDimension") : e;
  }
  function iv(t, e, n) {
    n = n || {};
    var i,
      ...
      o = !1;
    t ? ((o = !0), (i = bp(t))) : (o = (i = r.getSource()).sourceFormat === hc);
    var a = (function (t) {
  ...
  function uv(t, e, n, i) {
    var r = {},
      o = t[1] - t[0],
      a = (r.interval = Cr(o / e, !0));
    null != n && a < n && (a = r.interval = n),
      null != i && a > i && (a = r.interval = i);
    var s = (r.intervalPrecision = cv(a));
    return (
      (function (t, e) {
        ...
        (r.niceTickExtent = [
          dr(Math.ceil(t[0] / a) * a, s),
          dr(Math.floor(t[1] / a) * a, s),
        ]),
        t,
      ),
      r
  ...
  var yv = (function (t) {
    ...
    return (
      ...
      (e.prototype.contain = function (t) {
        return (
          fv((t = this.parse(t)), this._extent) &&
          null != this._ordinalMeta.categories[t]
        );
      }),
      (e.prototype.normalize = function (t) {
        return dv((t = this._getTickNumber(this.parse(t))), this._extent);
      }),
      (e.prototype.scale = function (t) {
        return (
          (t = Math.round(gv(t, this._extent))), this.getRawOrdinalNumber(t)
        );
      }),
  ...
  var vv = dr,
    mv = (function (t) {
      ...
      return (
        ...
        (e.prototype.contain = function (t) {
          return fv(t, this._extent);
        }),
        (e.prototype.normalize = function (t) {
          return dv(t, this._extent);
        }),
        (e.prototype.scale = function (t) {
        ...
        (e.prototype.getTicks = function (t) {
          ...
          if (!e) return o;
          n[0] < i[0] &&
            (t ? o.push({ value: vv(i[0] - e, r) }) : o.push({ value: n[0] }));
          for (
            var a = i[0];
            a <= i[1] &&
            (o.push({ value: a }),
            (a = vv(a + e, r)) !== o[o.length - 1].value);
          ...
          return (
            n[1] > s &&
              (t ? o.push({ value: vv(s + e, r) }) : o.push({ value: n[1] })),
            o
          );
        }),
        (e.prototype.getMinorTicks = function (t) {
        ...
        (e.prototype.calcNiceExtent = function (t) {
          ...
          t.fixMin || (e[0] = vv(Math.floor(e[0] / r) * r)),
            t.fixMax || (e[1] = vv(Math.ceil(e[1] / r) * r));
        }),
  ...
  rv.registerClass(mv);
  var _v = "undefined" != typeof Float32Array,
    xv = _v ? Float32Array : Array;
  function wv(t) {
    return H(t) ? (_v ? new Float32Array(t) : t) : new xv(t);
  }
  function bv(t) {
  ...
  function Tv(t) {
    ...
    return (
      R(t, function (t) {
        ...
        var p = fr(t.get("barWidth"), i),
          f = fr(t.get("barMaxWidth"), i),
          d = fr(t.get("barMinWidth") || (Dv(t) ? 0.5 : 1), i),
          g = t.get("barGap"),
        ...
        (e.prototype.getFormattedLabel = function (t, e, n) {
          ...
          return (function (t, e, n, i, r) {
            ...
            if (G(n)) o = n;
              ...
              var a = I({}, _h);
              if (t.level > 0)
                for (var s = 0; s < bh.length; ++s)
                  a[bh[s]] = "{primary|" + a[bh[s]] + "}";
              var l = n ? (!1 === n.inherit ? n : D(n, a)) : a,
                u = Dh(t.value, r);
              if (l[u]) o = l[u];
              else if (l.inherit) {
                for (s = Sh.indexOf(u) - 1; s >= 0; --s)
                  if (l[u]) {
                    o = l[u];
                    break;
                  }
                ...
                if (
                  ...
                  for (var u = 0; u < r.length - 1; u++) {
                    ...
                    if (h !== c) {
                      ...
                      switch (t) {
                        case "year":
                          (p = Math.max(1, Math.round(e / vh / 365))),
                            (f = Ah(n)),
                            (d = zh(n));
                          break;
                        case "half-year":
                        case "quarter":
                        case "month":
                          (p = Pv(e)), (f = Lh(n)), (d = Bh(n));
                          break;
                        case "week":
                        case "half-week":
                        case "day":
                          (p = Lv(e)), (f = Ph(n)), (d = Fh(n)), (g = !0);
                          break;
                        case "half-day":
                        case "quarter-day":
                        case "hour":
                          (p = Ov(e)), (f = Oh(n)), (d = Vh(n));
                          break;
                        case "minute":
                          (p = Rv(e, !0)), (f = Rh(n)), (d = Hh(n));
                          break;
                        case "second":
                          (p = Rv(e, !1)), (f = Nh(n)), (d = Wh(n));
                          break;
                        case "millisecond":
                          (p = Nv(e)), (f = Eh(n)), (d = Gh(n));
                      }
                      s(p, h, c, f, d, g, a),
                        "year" === t &&
                          o.length > 1 &&
          ...
          var o = Av.length,
            a = Math.min(
              (function (t, e, n, i) {
                ...
                return n;
              })(Av, this._approxInterval, 0, o),
              o - 1,
            );
          (this._interval = Av[a][1]),
            (this._minLevelUnit = Av[Math.max(a - 1, 0)][0]);
        }),
        (e.prototype.parse = function (t) {
          return X(t) ? t : +Sr(t);
        }),
        (e.prototype.contain = function (t) {
          return fv(this.parse(t), this._extent);
        }),
        (e.prototype.normalize = function (t) {
          return dv(this.parse(t), this._extent);
        }),
        (e.prototype.scale = function (t) {
          return gv(t, this._extent);
        }),
  ...
  function Lv(t, e) {
    return (t /= vh) > 16 ? 16 : t > 7.5 ? 7 : t > 3.5 ? 4 : t > 1.5 ? 2 : 1;
  }
  function Pv(t) {
    return (t /= 2592e6) > 6 ? 6 : t > 3 ? 3 : t > 2 ? 2 : 1;
  }
  function Ov(t) {
    return (t /= yh) > 12 ? 12 : t > 6 ? 6 : t > 3.5 ? 4 : t > 2 ? 2 : 1;
  }
  function Rv(t, e) {
    return (t /= e ? gh : dh) > 30
      ? 30
      ...
      return (
        ...
        (e.prototype.getTicks = function (t) {
          var e = this._originalScale,
            ...
            i = e.getExtent();
          return N(
            Bv.getTicks.call(this, t),
            function (t) {
              var e = t.value,
                r = dr(Wv(this.base, e));
              return (
                (r = e === n[0] && this._fixMin ? Yv(r, i[0]) : r),
                { value: (r = e === n[1] && this._fixMax ? Yv(r, i[1]) : r) }
              );
            },
            this,
          );
        ...
        (e.prototype.setExtent = function (t, e) {
          ...
          (t = Gv(Math.max(0, t)) / n),
            (e = Gv(Math.max(0, e)) / n),
            Bv.setExtent.call(this, t, e);
        }),
        (e.prototype.getExtent = function () {
          var t = this.base,
            e = zv.getExtent.call(this);
          (e[0] = Wv(t, e[0])), (e[1] = Wv(t, e[1]));
          var n = this._originalScale.getExtent();
          return (
            this._fixMin && (e[0] = Yv(e[0], n[0])),
            this._fixMax && (e[1] = Yv(e[1], n[1])),
            e
          );
        }),
        (e.prototype.unionExtent = function (t) {
        ...
        (e.prototype.calcNiceTicks = function (t) {
          ...
          if (!(n === 1 / 0 || n <= 0)) {
            ...
            for (
              ...
              i *= 10;
            var r = [dr(Hv(e[0] / i) * i), dr(Vv(e[1] / i) * i)];
            (this._interval = i), (this._niceExtent = r);
          }
        }),
        (e.prototype.calcNiceExtent = function (t) {
          Bv.calcNiceExtent.call(this, t),
        ...
        (e.prototype.contain = function (t) {
          return fv((t = Gv(t) / Gv(this.base)), this._extent);
        }),
        (e.prototype.normalize = function (t) {
          return dv((t = Gv(t) / Gv(this.base)), this._extent);
        }),
        (e.prototype.scale = function (t) {
          return (t = gv(t, this._extent)), Wv(this.base, t);
        }),
        (e.type = "log"),
        e
      );
  ...
  (Xv.getMinorTicks = Bv.getMinorTicks),
    (Xv.getLabel = Bv.getLabel),
    rv.registerClass(Uv);
  var qv = (function () {
      function t(t, e, n) {
      ...
      return (
        (t.prototype._prepareParams = function (t, e, n) {
          ...
          W(r)
            ? (this._modelMinNum = Kv(t, r({ min: n[0], max: n[1] })))
            : "dataMin" !== r && (this._modelMinNum = Kv(t, r));
          var o = (this._modelMaxRaw = e.get("max", !0));
          if (
            (W(o)
              ? (this._modelMaxNum = Kv(t, o({ min: n[0], max: n[1] })))
              : "dataMax" !== o && (this._modelMaxNum = Kv(t, o)),
            i)
          )
            ...
            "boolean" == typeof s[0] || "boolean" == typeof s[1]
              ...
              : (this._boundaryGapInner = [Yi(s[0], 1), Yi(s[1], 1)]);
          }
        }),
    ...
    Zv = { min: "_determinedMin", max: "_determinedMax" },
    jv = { min: "_dataMin", max: "_dataMax" };
  function Kv(t, e) {
  ...
  function Qv(t, e) {
    var n = e,
      ...
      r = i.extent,
      o = n.get("splitNumber");
    t instanceof Uv && (t.base = n.get("logBase"));
    var a = t.type,
      s = n.get("interval"),
      l = "interval" === a || "time" === a;
    t.setExtent(r[0], r[1]),
  ...
  function im(t) {
    return "category" === t.type && 0 === nm(t.getLabelModel());
  }
  var rm = (function () {
    function t() {}
    return (
  ...
  var am = Object.freeze({
    ...
    createScale: function (t, e) {
      var n = e;
      e instanceof rh || (n = new rh(e));
      var i = Jv(n);
      return i.setExtent(t[0], t[1]), Qv(i, n), i;
    },
    ...
    createTextStyle: function (t, e) {
      return Fu(t, null, null, "normal" !== (e = e || {}).state);
    },
    createDimensions: function (t, e) {
      return jy(t, e).dimensions;
    },
    createSymbol: Od,
    enableHoverEmphasis: Zs,
  });
  function sm(t, e) {
  ...
  function lm(t, e, n) {
    ...
    for (var o = 1; o < t.length; o++) {
      var a = t[o];
      (i += Sa(r[0], r[1], a[0], a[1], e, n)), (r = a);
    }
    var s = t[0];
    return (
      (sm(r[0], s[0]) && sm(r[1], s[1])) ||
        (i += Sa(r[0], r[1], s[0], s[1], e, n)),
      0 !== i
    );
  }
  var um = [];
        ...
        (e.prototype.getBoundingRect = function (t) {
          ...
          return (
            ...
            (isFinite(n[0]) &&
              ...
              isFinite(i[1])) ||
              (n[0] = n[1] = i[0] = i[1] = 0),
            (e = new Te(n[0], n[1], i[0] - n[0], i[1] - n[1])),
            t || (this._rect = e),
            e
          );
        }),
    ...
    n(e, t),
      (e.prototype.calcCenter = function () {
        for (
          ...
          he(i, r.getLocalTransform(), i), (r = r.parent);
        return de(i, i), Et(n, n, i), n;
      });
  })(pm);
  function ym(t, e, n) {
    for (var i = 0; i < t.length; i++) t[i] = vm(t[i], e[i], n);
  }
  function vm(t, e, n) {
    ...
    return N(
      ...
      function (t) {
        ...
        switch (i.type) {
          case "Polygon":
            var o = i.coordinates;
            r.push(new fm(o[0], o.slice(1)));
            break;
          case "MultiPolygon":
            R(i.coordinates, function (t) {
              t[0] && r.push(new fm(t[0], t.slice(1)));
            });
            break;
          case "LineString":
            r.push(new dm([i.coordinates]));
            break;
          case "MultiLineString":
            r.push(new dm(i.coordinates));
        }
        var a = new gm(n[e || "name"], r, n.cp);
  ...
  var _m = Object.freeze({
      ...
      getPrecision: gr,
      getPrecisionSafe: yr,
      getPixelPrecision: vr,
      getPercentWithPrecision: function (t, e, n) {
        return (t[e] && mr(t, n)[e]) || 0;
      },
      MAX_SAFE_INTEGER: 9007199254740991,
      remRadian: xr,
      isRadianAroundZero: wr,
      parseDate: Sr,
      quantity: Mr,
      quantityExponent: Tr,
      nice: Cr,
    ...
    xm = Object.freeze({ __proto__: null, parse: Sr, format: Ih }),
    wm = Object.freeze({
      __proto__: null,
      ...
      clipPointsByRect: function (t, e) {
        return N(t, function (t) {
          var n = t[0];
          (n = wu(n, e.x)), (n = bu(n, e.x + e.width));
          var i = t[1];
          return (i = wu(i, e.y)), [n, (i = bu(i, e.y + e.height))];
        });
      },
      clipRectByRect: function (t, e) {
        var n = wu(t.x, e.x),
          i = bu(t.x + t.width, e.x + e.width),
          r = wu(t.y, e.y),
          o = bu(t.y + t.height, e.y + e.height);
        if (i >= n && o >= r)
          return { x: n, y: r, width: i - n, height: o - r };
      },
      registerShape: Tu,
      getShapeClass: function (t) {
        if (Su.hasOwnProperty(t)) return Su[t];
      },
      Group: rr,
      Image: Va,
      Text: ja,
    ...
    return "category" === t.type
      ? (function (t, e) {
          ...
          if (W(o)) n = Pm(t, o, !0);
            ...
            var s = Im(t, t.getLabelModel());
            (i = s.labelCategoryInterval),
              (n = N(s.labels, function (t) {
                return t.tickValue;
              }));
          } else n = Lm(t, (i = o), !0);
          return Am(r, o, { ticks: n, tickCategoryInterval: i });
        })(t, e)
      : {
        ...
        : ((i =
            "auto" === o
              ? (function (t) {
                  ...
                  return null != e
                    ? e
                    : (Mm(t).autoInterval = t.calculateCategoryInterval());
                })(t)
              : o),
          (n = Lm(t, i))),
      Am(r, o, { labels: n, labelCategoryInterval: i }))
    );
  }
  function Dm(t, e) {
    ...
    Rm = (function () {
      ...
      return (
        ...
        (t.prototype.getPixelPrecision = function (t) {
          return vr(t || this.scale.getExtent(), this._extent);
        }),
        (t.prototype.setExtent = function (t, e) {
          var n = this._extent;
          (n[0] = t), (n[1] = e);
        ...
        (t.prototype.coordToData = function (t, e) {
          var n = this._extent,
            i = this.scale;
          this.onBand && "ordinal" === i.type && Nm((n = n.slice()), i.count());
          var r = pr(t, n, Om, e);
        ...
        (t.prototype.getTicksCoords = function (t) {
          ...
          return (
            (function (t, e, n, i) {
              ...
              function c(t, e) {
                return (t = dr(t)), (e = dr(e)), h ? t > e : t < e;
              }
        ...
        (t.prototype.calculateCategoryInterval = function () {
          return (function (t) {
            ...
            for (
              ...
              var d,
                g,
                y = Wi(n({ value: l }), e.font, "center", "top");
              (d = 1.3 * y.width),
                (g = 1.3 * y.height),
                (p = Math.max(p, d, 7)),
                (f = Math.max(f, g, 7));
  ...
  function Um(t, e) {
    if (e <= 180 && e > 0) {
      ...
      var n = Vm.len(),
        i = Hm.len();
      if (!(n < 0.001 || i < 0.001)) {
        Vm.scale(1 / n), Hm.scale(1 / i);
        var r = Vm.dot(Hm);
        if (Math.cos(e) < r) {
          var o = Em(Bm.x, Bm.y, Fm.x, Fm.y, zm.x, zm.y, Wm, !1);
          Gm.fromArray(Wm), Gm.scaleAndAdd(Hm, o / Math.tan(Math.PI - e));
          var a =
            Fm.x !== Bm.x
              ? (Gm.x - Bm.x) / (Fm.x - Bm.x)
              : (Gm.y - Bm.y) / (Fm.y - Bm.y);
          if (isNaN(a)) return;
          a < 0 ? ye.copy(Gm, Bm) : a > 1 && ye.copy(Gm, Fm), Gm.toArray(t[1]);
        }
      }
    }
  }
  function Xm(t, e, n) {
    if (n <= 180 && n > 0) {
      ...
      var i = Vm.len(),
        r = Hm.len();
      if (!(i < 0.001 || r < 0.001))
        if ((Vm.scale(1 / i), Hm.scale(1 / r), Vm.dot(e) < Math.cos(n))) {
          var o = Em(Bm.x, Bm.y, Fm.x, Fm.y, zm.x, zm.y, Wm, !1);
          Gm.fromArray(Wm);
          var a = Math.PI / 2,
            s = a + Math.acos(Hm.dot(e)) - n;
          if (s >= a) ye.copy(Gm, Fm);
          else {
            Gm.scaleAndAdd(Hm, o / Math.tan(Math.PI / 2 - s));
            var l =
              Fm.x !== Bm.x
                ? (Gm.x - Bm.x) / (Fm.x - Bm.x)
                : (Gm.y - Bm.y) / (Fm.y - Bm.y);
            if (isNaN(l)) return;
            l < 0 ? ye.copy(Gm, Bm) : l > 1 && ye.copy(Gm, Fm);
          }
          Gm.toArray(t[1]);
        }
    }
  ...
  var Km = (function (t) {
      function e(e, n, i) {
        ...
        (o.motionBlur = !1),
          ...
          (i = i || Ii),
          "string" == typeof e ? (r = jm(e, n, i)) : Y(e) && (e = (r = e).id),
          (o.id = e),
          (o.dom = r);
        var a = r.style;
        return (
      ...
      return (
        ...
        (e.prototype.createBackBuffer = function () {
          var t = this.dpr;
          (this.domBack = jm("back-" + this.id, this.painter, t)),
        ...
        (e.prototype.createRepaintRects = function (t, e, n, i) {
          ...
          function u(t) {
            if (t.isFinite() && !t.isZero())
              if (0 === o.length) {
                (e = new Te(0, 0, 0, 0)).copy(t), o.push(e);
              } else {
                for (
              ...
              if (K(e))
                (a =
                  ((e.global || (e.__width === i && e.__height === o)) &&
                    e.__canvasGradient) ||
                  Ed(r, e, { x: 0, y: 0, width: i, height: o })),
  ...
  var t_ = (function () {
    function t(t, e, n, i) {
      ...
      if (r) {
        ...
        (this._width = Bd(t, 0, n)), (this._height = Bd(t, 1, n));
    ...
    return (
      ...
      (t.prototype._paintHoverList = function (t) {
        ...
        if ((n && n.clear(), e)) {
          for (
            ...
            var a = t[o];
            a.__inHover &&
              (n || (n = this._hoverlayer = this.getLayer($m)),
              i || (i = n.ctx).save(),
              eg(i, a, r, o === e - 1));
          }
          i && i.restore();
      ...
      (t.prototype._doPaintEl = function (t, e, n, i, r, o) {
        ...
        if (n) {
          ...
          (!i || (s && s.intersect(i))) &&
            (eg(a, t, r, o), t.setPrevPaintRect(s));
        } else eg(a, t, r, o);
      }),
      (t.prototype.getLayer = function (t, e) {
        ...
        return (
          n ||
            (((n = new Km("zr_" + t, this, this.dpr)).zlevel = t),
            (n.__builtin__ = !0),
            this._layerConfig[t]
              ? C(n, this._layerConfig[t], !0)
              : this._layerConfig[t - Jm] &&
                C(n, this._layerConfig[t - Jm], !0),
            e && (n.virtual = e),
      ...
      (t.prototype.configLayer = function (t, e) {
        if (e) {
          ...
          for (var i = 0; i < this._zlevelList.length; i++) {
            ...
            if (r === t || r === t + Jm) C(this._layers[r], n[t], !0);
          }
        }
      }),
      ...
      (t.prototype.getRenderedCanvas = function (t) {
        ...
        var e = new Km("image", this, t.pixelRatio || this.dpr);
        e.initContext(),
  ...
  var e_ = (function (t) {
    ...
    return (
      ...
      (e.prototype.getInitialData = function (t) {
        return iv(null, this, { useEncodeDefaulter: !0 });
      }),
  ...
  function n_(t, e) {
    ...
    if (i) {
      for (var o = [], a = 0; a < n.length; a++) o.push(Bp(t, e, n[a]));
      return o.join(" ");
    }
  }
  function i_(t, e) {
  ...
  var r_ = (function (t) {
    ...
    return (
      ...
      (e.prototype.updateData = function (t, n, i, r) {
        ...
        if ((this._updateCommon(t, n, s, i, r), l)) {
          ...
          if (!u) {
            ...
            (p.scaleX = p.scaleY = 0), (p.style.opacity = 0), gu(p, c, a, n);
          }
        }
      ...
      (e.prototype._updateCommon = function (t, e, n, i, r) {
        ...
        var _ = Rd(t.getItemVisual(e, "symbolOffset"), n);
        ...
        if (d instanceof Va) {
          ...
          d.__isEmptyBrush ? d.useStyle(I({}, x)) : d.useStyle(x),
            (d.style.decal = null),
      ...
      (e.prototype.fadeOut = function (t, e, n) {
        ...
        vu(i, { style: { opacity: 0 }, scaleX: 0, scaleY: 0 }, e, {
          dataIndex: r,
          cb: t,
          removeOpt: o,
        });
  ...
  function l_(t) {
    ...
    return {
      ...
      labelStatesModels: Bu(e),
      cursorStyle: e.get("cursor"),
    };
  }
  var u_ = (function () {
    function t(t) {
      (this.group = new rr()), (this._SymbolCtor = t || r_);
    }
    return (
      (t.prototype.updateData = function (t, e) {
        (this._progressiveEls = null), (e = s_(e));
        var n = this.group,
          i = t.hostModel,
          r = this._data,
          o = this._SymbolCtor,
      ...
      (t.prototype.eachRendered = function (t) {
        Ru(this._progressiveEls || this.group, t);
      }),
      (t.prototype.remove = function (t) {
        var e = this.group,
          n = this._data;
          ...
          if (M >= i || d_(b, S)) (f = v), (d = m);
            ...
            if ("x" === s) {
              ...
              (R = Math.sqrt(A * A + P * P)),
                ...
                (d = m - I * a * (1 - T)),
                (k = m + I * a * T),
                (D = p_((D = v + C * a * T), f_(b, v))),
                (k = p_(k, f_(S, m))),
                (D = f_(D, p_(b, v))),
                (d = m - ((I = (k = f_(k, p_(S, m))) - m) * R) / N),
                (f = p_((f = v - ((C = D - v) * R) / N), f_(u, v))),
                (d = p_(d, f_(h, m))),
                (D = v + ((C = v - (f = f_(f, p_(u, v)))) * N) / R),
                (k = m + ((I = m - (d = f_(d, p_(h, m)))) * N) / R);
          }
      ...
      return (
        ...
        (e.prototype.buildPath = function (t, e) {
          var n = e.points,
            ...
            r = n.length / 2;
          if (e.connectNulls) {
            for (; r > 0 && d_(n[2 * r - 2], n[2 * r - 1]); r--);
            for (; i < r && d_(n[2 * i], n[2 * i + 1]); i++);
          }
          for (; i < r; )
            i +=
              g_(t, n, i, r, r, 1, e.smooth, e.smoothMonotone, e.connectNulls) +
              1;
        }),
            ...
            switch (r[l++]) {
              ...
              case o.C:
                (u = r[l++]),
                  ...
                  (f = r[l++]),
                  (d = r[l++]);
                var v = a ? ln(n, u, c, f, t, s) : ln(i, h, p, d, t, s);
                if (v > 0)
                  for (var m = 0; m < v; m++) {
                    var _ = s[m];
                    if (_ <= 1 && _ >= 0) {
                      y = a ? an(i, h, p, d, _) : an(n, u, c, f, _);
                      return a ? [t, y] : [y, t];
                    }
                  }
                (n = f), (i = d);
      ...
      return (
        ...
        (e.prototype.buildPath = function (t, e) {
          var n = e.points,
            ...
            a = e.smoothMonotone;
          if (e.connectNulls) {
            for (; o > 0 && d_(n[2 * o - 2], n[2 * o - 1]); o--);
            for (; r < o && d_(n[2 * r], n[2 * r + 1]); r++);
          }
          for (; r < o; ) {
            var s = g_(t, n, r, o, o, 1, e.smooth, a, e.connectNulls);
            g_(t, i, r + s - 1, s, o, -1, e.stackedOnSmooth, a, e.connectNulls),
              (r += s + 1),
              t.closePath();
          }
        }),
  ...
  function x_(t, e, n, i, r) {
    ...
    (a -= h / 2),
      ...
      (a = Math.floor(a)),
      (l = Math.round(l));
    var c = new Ya({ shape: { x: a, y: s, width: l, height: u } });
    if (e) {
      var p = t.getBaseAxis(),
        f = p.isHorizontal(),
        d = p.inverse;
      ...
      var g = W(r)
        ...
        : null;
      gu(c, { shape: { width: l, height: u, x: a, y: s } }, n, null, i, g);
    }
    return c;
  }
  function w_(t, e, n) {
    ...
    e &&
      ("angle" === t.getBaseAxis().dim
        ...
        : (a.shape.r = r),
      gu(a, { shape: { endAngle: i.endAngle, r: o } }, n));
    return a;
  }
  function b_(t, e) {
    return t.type === e;
      ...
      if (o) {
        ...
        var p = (function (t, e) {
            ...
            function a(t, e, n) {
              ...
              return {
                coord: n,
                color: Vn((n - i) / (e.coord - i), [t.color, e.color]),
              };
            }
            for (var s = 0; s < o; s++) {
              var l = t[s],
        ...
        (!r ||
          !(function (t, e) {
            ...
            for (
              ...
              if (1.5 * r_.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i)
                return !1;
            return !0;
          })(o, e))
      ) {
  ...
  function L_(t) {
    ...
    for (var e = 0; e < ps.length; e++)
      if (t.get([ps[e], "endLabel", "show"])) return !0;
    return !1;
  }
  function P_(t, e, n, i) {
    if (b_(e, "cartesian2d")) {
  ...
  var O_ = (function (t) {
    ...
    return (
      ...
      (e.prototype.render = function (t, e, n) {
        var i = this,
          ...
          x =
            ...
            (function (t, e, n) {
              ...
              for (var i = e.count(), r = wv(2 * i), o = 0; o < i; o++) {
                var a = c_(n, t, e, o);
        ...
        var I = D_(a, r, n) || a.getVisual("style")[a.getVisual("drawType")];
        if (f && c.type === r.type && C === this._step) {
          v && !d
            ? (d = this._newPolygon(u, x))
            : d && !v && (g.remove(d), (d = this._polygon = null)),
            h || this._initOrUpdateEndLabel(t, r, jh(I));
          var k = g.getClipPath();
          if (k) gu(k, { shape: P_(this, r, !1, t).shape }, t);
          else g.setClipPath(P_(this, r, !0, t));
          w &&
            p.updateData(a, {
              isIgnore: S,
              clipShape: T,
            ...
            (S_(this._stackedOnPoints, x) && S_(this._points, u)) ||
              (y
                ? this._doUpdateAnimation(a, x, r, n, C, m, b)
                : (C && ((u = I_(u, r, C, b)), x && (x = I_(x, r, C, b))),
                  f.setShape({ points: u }),
          ...
          w &&
            ...
            h || this._initOrUpdateEndLabel(t, r, jh(I)),
            g.setClipPath(P_(this, r, !0, t));
        var A = t.getModel("emphasis"),
          L = A.get("focus"),
          P = A.get("blurScope"),
          O = A.get("disabled");
        (f.useStyle(
          D(s.getLineStyle(), { fill: "none", stroke: I, lineJoin: "bevel" }),
        ),
        Qs(f, t, "lineStyle"),
        f.style.lineWidth > 0 &&
          "bolder" === t.get(["emphasis", "lineStyle", "width"])) &&
          (f.getState("emphasis").style.lineWidth = +f.style.lineWidth + 1);
        (ss(f).seriesIndex = t.seriesIndex), js(f, L, P, O);
        var R = C_(t.get("smooth")),
        ...
        if (
          ...
          d.useStyle(
            ...
            Qs(d, t, "areaStyle"),
            (ss(d).seriesIndex = t.seriesIndex),
            js(d, L, P, O);
        }
        var B = function (t) {
        ...
        if (
          ...
          if (!s) {
            ...
            var h = t.get("zlevel") || 0,
              c = t.get("z") || 0;
            ((s = new r_(r, o)).x = l), (s.y = u), s.setZ(h, c);
          ...
          s.highlight();
        } else Af.prototype.highlight.call(this, t, e, n, i);
      }),
        ...
        if ((this._changePolyState("normal"), null != o && o >= 0)) {
          ...
          a &&
            (a.__temp
              ...
              : a.downplay());
        } else Af.prototype.downplay.call(this, t, e, n, i);
      }),
      (e.prototype._changePolyState = function (t) {
        var e = this._polygon;
        Ls(this._polyline, t), e && Ls(e, t);
      }),
      ...
      (e.prototype._initOrUpdateEndLabel = function (t, e, n) {
        ...
        if (L_(t)) {
          ...
          s ||
            (((s = this._endLabel = new ja({ z2: 200 })).ignoreClip = !0),
                  ...
                  for (
                    ...
                    if (c && "ordinal" === c.type)
                      ...
                      var p = s && s[h] ? s[h] : 0,
                        f = l[h],
                        d = Or(p, f, r);
                      a[h] = dr(d, o ? Math.max(gr(p), gr(f)) : e);
                    }
                  }
                  return a;
                })(n, p, I, D, b.t));
      ...
      (e.prototype._doUpdateAnimation = function (t, e, n, i, r, o, a) {
              ...
              switch (x.cmd) {
                ...
                case "+":
                  var D = x.idx,
                    ...
                    A = r.dataToPoint([e.get(k[0], D), e.get(k[1], D)]);
        ...
        if (
          (r &&
            ((c = I_(h.current, n, r, a)),
            (p = I_(h.stackedOnCurrent, n, r, a)),
            (f = I_(h.next, n, r, a)),
            (d = I_(h.stackedOnNext, n, r, a))),
          T_(c, f) > 3e3 || (l && T_(p, d) > 3e3))
        )
          return (
            s.stopAnimation(),
            s.setShape({ points: f }),
        ...
        h.current !== c && (g.shape.__points = h.next),
          ...
          l &&
            ...
            l.stopAnimation(),
            du(l, { shape: { stackedOnPoints: d } }, u),
      ...
      reset: function (t, e, n) {
        ...
        if (a > 10 && "cartesian2d" === o.type && r) {
          ...
          if (isFinite(p) && p > 1) {
            ...
            var f = void 0;
            G(r) ? (f = R_[r]) : W(r) && (f = r),
              f && t.setData(i.downSample(i.mapDimension(l.dim), 1 / p, f, N_));
          }
        }
      },
    };
          ...
          a.diff(s)
            .add(function (e) {
              var n = a.getItemModel(e),
                i = J_[l.type](a, e, n);
              if ((g && b(e), a.hasValue(e) && Q_[l.type](i))) {
                var s = !1;
                p && (s = Y_[l.type](f, i));
                var y = q_[l.type](t, a, e, i, r, h, u.model, !1, d);
                c && (y.forceLabelAnimation = !0),
                  ex(y, a, e, n, i, t, r, "polar" === l.type),
                  x
                    ? y.attr({ shape: i })
                    : c
                    ? Z_(c, h, y, i, e, r, !1, !1)
              ...
              if (g) {
                ...
                0 === _.length
                  ...
                  : ((M = _[n]).useStyle(y.getItemStyle()),
                    ...
                    (m[e] = M));
                var T = J_[l.type](a, e);
                du(M, { shape: ax(r, T, l) }, h, e);
              }
              var C = s.getItemGraphicEl(n);
              if (a.hasValue(e) && Q_[l.type](S)) {
                var I = !1;
                if (
                  (p && (I = Y_[l.type](f, S)) && o.remove(C),
                  C
                    ? xu(C)
                    : (C = q_[l.type](t, a, e, S, r, h, u.model, !!C, d)),
                ...
                } else ex(C, a, e, i, S, t, r, "polar" === l.type);
                x
                  ? C.attr({ shape: S })
                  : c
                  ? Z_(c, h, C, S, e, r, !0, w)
                  : du(C, { shape: S }, t, e, null),
            ...
            .execute();
          var S = this._backgroundGroup || (this._backgroundGroup = new rr());
          S.removeAll();
          for (var M = 0; M < m.length; ++M) S.add(m[M]);
          o.add(S), (this._backgroundEls = m), (this._data = a);
        }),
        (e.prototype._renderLarge = function (t, e, n) {
          this._clear(), rx(t, this.group), this._updateLargeClip(t);
        }),
        (e.prototype._incrementalRenderLarge = function (t, e) {
          this._removeBackground(), rx(e, this.group, this._progressiveEls, !0);
        }),
      ...
      polar: function (t, e, n, i, r, o, a, s, l) {
        ...
        if (
          ((h.calculateTextPosition =
            ((c = f),
            (p = ({ isRoundCap: u === V_ } || {}).isRoundCap),
            function (t, e, n) {
              var i = e.position;
              if (!i || i instanceof Array) return qi(t, e, n);
              var r = c(i),
              ...
              switch (r) {
                ...
                case "insideStartArc":
                  ...
                  break;
                case "startAngle":
                  (x = s + f * m(d) + H_(d, o + v, !1)),
                    (w = l + f * _(d) + W_(d, o + v, !1)),
                    (b = "right"),
                    (S = "middle");
                  break;
                ...
                case "insideEndArc":
                  ...
                  break;
                case "endAngle":
                  (x = s + f * m(g) + H_(g, o + v, !0)),
                    (w = l + f * _(g) + W_(g, o + v, !0)),
                    (b = "left"),
                    (S = "middle");
                  break;
                case "insideEndAngle":
  ...
  function Z_(t, e, n, i, r, o, a, s) {
    var l, u;
    o
      ? ((u = { x: i.x, width: i.width }), (l = { y: i.y, height: i.height }))
      : ((u = { y: i.y, height: i.height }), (l = { x: i.x, width: i.width })),
      s || (a ? du : gu)(n, { shape: l }, e, r, null),
      (a ? du : gu)(n, { shape: u }, e ? t.baseAxis.model : null, r);
  }
  function j_(t, e) {
    for (var n = 0; n < e.length; n++) if (!isFinite(t[e[n]])) return !0;
    return !1;
  }
  var K_ = ["x", "y", "width", "height"],
    $_ = ["cx", "cy", "r", "startAngle", "endAngle"],
    Q_ = {
  ...
  function ex(t, e, n, i, r, o, a, s) {
    ...
    if (s && p) {
      ...
      (t.textConfig.inside = "middle" === f || null),
        (function (t, e, n, i) {
        ...
        })(t, "outside" === f ? h : f, tx(a), i.get(["label", "rotate"]));
    }
    !(function (t, e, n, i) {
      if (t) {
        var r = Xu(t);
    ...
    })(p, c, o.getRawValue(n), function (t) {
      return i_(e, t);
    });
    var d = i.getModel(["emphasis"]);
    js(t, d.get("focus"), d.get("blurScope"), d.get("disabled")),
      Qs(t, i),
      (function (t) {
        return (
          null != t.startAngle &&
  ...
  function rx(t, e, n, i) {
    ...
    (c.baseDimIdx = o),
      ...
      (ss(c).seriesIndex = t.seriesIndex),
      t.get("silent") || (c.on("mousedown", ox), c.on("mousemove", ox)),
      n && n.push(c);
  }
  var ox = Ef(
    function (t) {
  ...
  var sx = 2 * Math.PI,
    lx = Math.PI / 180;
  function ux(t, e) {
    return tc(t.getBoxLayoutParams(), {
      width: e.getWidth(),
      height: e.getHeight(),
    });
  }
  function hx(t, e) {
    ...
    var o,
      a,
      s = fr(n.width, e.getWidth()),
      l = fr(n.height, e.getHeight()),
      u = Math.min(s, l),
      h = fr(r[0], u / 2),
      c = fr(r[1], u / 2),
    ...
    if (p) {
      ...
      H(i) || (i = [i, i]), (o = fr(i[0], s) + n.x), (a = fr(i[1], l) + n.y);
  ...
  var px = Math.PI / 180;
  function fx(t, e, n, i, r, o, a, s, l, u) {
    if (!(t.length < 2)) {
    ...
    function f(t) {
      for (var o = t.rB, a = o * o, s = 0; s < t.list.length; s++) {
        var l = t.list[s],
          ...
          f = e + (p + l.len2) * r,
          d = f - l.label.x;
        dx(l, l.targetTextWidth - d * r, !0), (l.label.x = f);
      }
    }
  }
  function dx(t, e, n) {
  ...
  function yx(t) {
    var e,
      ...
      r = [],
      o = !1,
      a = (t.get("minShowLabelAngle") || 0) * px,
    ...
    i.each(function (t) {
      var s = i.getItemGraphicEl(t),
        ...
        _ = y.get("alignTo"),
        x = fr(y.get("edgeDistance"), u),
        w = y.get("bleedMargin"),
        b = g.getModel("labelLine"),
        S = b.get("length");
      S = fr(S, u);
      var M = b.get("length2");
      if (((M = fr(M, u)), Math.abs(c.endAngle - c.startAngle) < a))
        return (
          R(p.states, f),
          (p.ignore = !0),
      ...
      !o &&
        ...
        (function (t, e, n, i, r, o, a, s) {
          ...
          for (
            fx(u, e, n, i, 1, 0, o, 0, s, c),
              fx(l, e, n, i, -1, 0, o, 0, s, h),
              p = 0;
            p < t.length;
            p++
          ) {
    ...
    for (var d = 0; d < r.length; d++) {
      ...
      if (v) {
        ...
        m || !x
          ...
          : (Um(x, g.minTurnAngle),
            Xm(x, g.surfaceNormal, g.maxSurfaceAngle),
            v.setShape({ points: x }),
      ...
      return (
        ...
        (e.prototype.updateData = function (t, e, n, i) {
          var r = this,
            ...
            l = t.getItemLayout(e),
            u = I(vx(a.getModel("itemStyle"), l, !0), l);
          if (isNaN(u.startAngle)) r.setShape(u);
            ...
            if (i) {
              ...
              o.ecModel.ssr
                ? (gu(r, { scaleX: 0, scaleY: 0 }, o, {
                  ...
                  (r.originY = u.cy))
                : "scale" === h
                ? ((r.shape.r = l.r0), gu(r, { shape: { r: l.r } }, o, e))
                : null != n
                ...
                : ((r.shape.endAngle = l.startAngle),
                  du(r, { shape: { endAngle: l.endAngle } }, o, e));
            } else xu(r), du(r, { shape: u }, o, e);
            r.useStyle(t.getItemVisual(e, "style")), Qs(r, a);
            ...
            g && r.attr("cursor", g),
              ...
              (r.ensureState("emphasis").shape = I(
                { r: l.r + ((s.get("scale") && s.get("scaleSize")) || 0) },
                vx(s.getModel("itemStyle"), l),
              )),
              I(r.ensureState("select"), {
                x: f,
                y: d,
                shape: vx(a.getModel(["select", "itemStyle"]), l),
              }),
              I(r.ensureState("blur"), {
                shape: vx(a.getModel(["blur", "itemStyle"]), l),
              });
            var y = r.getTextGuideLine(),
              v = r.getTextContent();
            y && I(y.ensureState("select"), { x: f, y: d }),
              I(v.ensureState("select"), { x: f, y: d }),
        ...
        (e.prototype._updateLabel = function (t, e, n) {
          ...
          if ("outside" !== h && "outer" !== h) i.removeTextGuideLine();
            ...
            c || ((c = new Xl()), this.setTextGuideLine(c)),
              (function (t, e, n) {
      ...
      return (
        ...
        (e.prototype.init = function (e) {
          t.prototype.init.apply(this, arguments),
            (this.legendVisualProvider = new xx(
              F(this.getData, this),
        ...
        (e.prototype.getDataParams = function (e) {
          ...
          if (!r) {
            ...
            n.each(n.mapDimension("value"), function (t) {
              ...
              (r = i.seats = mr(o, n.hostModel.get("percentPrecision")));
          }
    ...
    Tx = (function (t) {
      ...
      return (
        ...
        (e.prototype.getCoordSysModel = function () {
          return this.getReferringComponents("grid", $r).models[0];
        }),
  ...
  var Cx = {
    ...
    Ax = { value: 1, category: 1, time: 1, log: 1 };
  function Lx(t, e, i, r) {
    R(Ax, function (o, a) {
      var s = C(C({}, kx[a], !0), r, !0),
        l = (function (t) {
          function i() {
            var n = (null !== t && t.apply(this, arguments)) || this;
          ...
          return (
            ...
            (i.prototype.optionUpdated = function () {
              "category" === this.option.type &&
                (this.__ordinalMeta = av.createByAxisModel(this));
            }),
      ...
      t.registerSubTypeDefaulter(e + "Axis", Px);
  }
  function Px(t) {
  ...
  var Ex = (function (t) {
      function e() {
        var e = (null !== t && t.apply(this, arguments)) || this;
        return (e.type = "cartesian2d"), (e.dimensions = Rx), e;
      }
      return (
        n(e, t),
        ...
        (e.prototype.containZone = function (t, e) {
          var n = this.dataToPoint(t),
            ...
            r = this.getArea(),
            o = new Te(n[0], n[1], i[0] - n[0], i[1] - n[1]);
    ...
    return (
      R(e, function (n, i) {
        var r = i.replace(/Model$/, ""),
          o = t.getReferringComponents(r, $r).models[0];
        e[i] = o;
      }),
      e
    );
  ...
  function Hx(t, e, n) {
    ...
    if (h && c) d = (y - g) / a;
      ...
      t.getTicks().length - 1 > a && (d = hv(d));
      var v = d * a;
      (g = dr((y = Math.ceil(u[1] / d) * d) - v)) < 0 && u[0] >= 0
        ? ((g = 0), (y = dr(v)))
        : y > 0 && u[1] <= 0 && ((y = 0), (g = -dr(v)));
    }
    ...
    return (
          ...
          if (i) {
            for (var r = [], o = i - 1; o >= 0; o--) {
              var a = t[+n[o]],
                s = a.model,
                l = a.scale;
              lv(l) && s.get("alignTicks") && null == s.get("interval")
                ? r.push(a)
                : (Qv(l, s), lv(l) && (e = a));
            }
            r.length &&
              (e || Qv((e = r.pop()).scale, e.model),
              R(r, function (t) {
                Hx(t.scale, t.model, e.scale);
              }));
          }
        }
      ...
      (t.prototype.resize = function (t, e, n) {
        var i = t.getBoxLayoutParams(),
          ...
          o = tc(i, { width: e.getWidth(), height: e.getHeight() });
        this._rect = o;
                ...
                var e = (function (t) {
                  ...
                  if (e.get(["axisLabel", "show"]) && !n.isBlank()) {
                    var i,
                      r,
                      o = n.getExtent();
                    r = n instanceof yv ? n.count() : (i = n.getTicks()).length;
                    var a,
                      s = t.getLabelModel(),
                      l = tm(t),
                      u = 1;
                    ...
                    for (var h = 0; h < r; h += u) {
                      var c = l(i ? i[h] : { value: o[0] + h }, h),
                        p = em(s.getTextRect(c), s.get("rotate") || 0);
                      a ? a.union(p) : (a = p);
                    }
                    return a;
                  }
      ...
      (t.prototype._findConvertTarget = function (t) {
        var e,
          ...
          r =
            t.xAxisModel ||
            (i && i.getReferringComponents("xAxis", $r).models[0]),
          o =
            t.yAxisModel ||
            (i && i.getReferringComponents("yAxis", $r).models[0]),
          a = t.gridModel,
          s = this._coordsList;
            ...
            if (Gx(n, t)) {
              ...
              "x" === e
                ...
                : "left" !== l &&
                  ...
                  (l = o.left ? "right" : "left"),
                (o[l] = !0);
              var u = new zx(e, Jv(n), [0, 0], n.get("type"), l),
                h = "category" === u.type;
  ...
  function Ux(t, e, n, i) {
    ...
    if (s) {
      if (null != l) Xx(o[l]) && (r = o[l]);
      else
        for (var u in o)
          if (o.hasOwnProperty(u) && Xx(o[u]) && !i[h(o[u])]) {
            r = o[u];
            break;
          }
      r && (i[h(r)] = !0);
  ...
  var Yx = Math.PI,
    qx = (function () {
      ...
      return (
        ...
        (t.prototype.add = function (t) {
          Zx[t](this.opt, this.axisModel, this.group, this._transformGroup);
        }),
    ...
    Zx = {
      axisLine: function (t, e, n, i) {
        ...
        if (
          ...
          Lu(c.shape, c.style.lineWidth), (c.anid = "line"), n.add(c);
          var p = e.get(["axisLine", "symbol"]);
          if (null != p) {
            var f = e.get(["axisLine", "symbolSize"]);
            G(p) && (p = [p, p]), (G(f) || X(f)) && (f = [f, f]);
            var d = Rd(e.get(["axisLine", "symbolOffset"]) || 0, f),
              g = f[0],
              y = f[1];
            R(
              [
              ...
              function (e, i) {
                if ("none" !== p[i] && null != p[i]) {
                  var r = Od(p[i], -g / 2, -y / 2, g, y, h.stroke, !0),
                    o = e.r + e.offset,
                    a = u ? l : s;
                  r.attr({
                    rotation: e.rotate,
      ...
      axisTickLabel: function (t, e, n, i) {
        var r = (function (t, e, n, i) {
          ...
          o = (function (t, e, n, i) {
            var r = n.axis;
            if (
              !tt(i.axisLabelShow, n.get(["axisLabel", "show"])) ||
              r.scale.isBlank()
            )
              return;
            var o = n.getModel("axisLabel"),
              a = o.get("margin"),
              s = r.getViewLabels(),
              l = ((tt(i.labelRotate, o.get("rotate")) || 0) * Yx) / 180,
              u = qx.innerTextLayout(i.rotation, l, i.labelDirection),
              h = n.getCategories && n.getCategories(!0),
              c = [],
              p = qx.isLabelSilent(n),
            ...
            return (
              R(s, function (s, l) {
                ...
                if (h && h[d]) {
                  ...
                  Y(m) &&
                    m.textStyle &&
                    (v = new rh(m.textStyle, o, n.ecModel));
                }
                var _ =
                    v.getTextColor() ||
        ...
        ((function (t, e, n) {
          ...
          !1 === i
            ? (jx(o), jx(u))
            : Kx(o, a) && (i ? (jx(a), jx(h)) : (jx(o), jx(u)));
          !1 === r
            ? (jx(s), jx(c))
            : Kx(l, s) && (r ? (jx(l), jx(p)) : (jx(s), jx(c)));
        })(e, o, r),
        (function (t, e, n, i) {
          var r = n.axis,
          ...
          for (
            ...
            for (
              var c = Qx(a[h], e.transform, l, u, "minorticks_" + h), p = 0;
              p < c.length;
              p++
            )
              t.add(c[p]);
            ...
            for (var r = 0; r < t.length; r++) {
              ...
              for (var c = o.obb, p = !1, f = 0; f < e.length; f++) {
                ...
                if (n.intersect(d.rect)) {
                  ...
                  if (
                    (d.obb || (d.obb = new uu(d.localRect, d.transform)),
                    c || (c = new uu(s, l)),
                    c.intersect(d.obb))
                  ) {
                    p = !0;
          ...
          if (
            ((function (t) {
              ...
              (u.componentMainType = o),
                ...
                (u.tooltipConfig = {
                  name: i,
                  option: D({ content: i, formatterParams: s }, r),
                });
  ...
  function Kx(t, e) {
    ...
    if (n && i) {
      ...
      return (
        pe(r, r, -t.rotation),
        n.applyTransform(he([], r, t.getLocalTransform())),
        i.applyTransform(he([], r, e.getLocalTransform())),
        n.intersect(i)
      );
    }
  }
  ...
  var ew = {},
    ...
    iw = qr();
  var rw = ["axisLine", "axisTickLabel", "axisName"],
    ow = ["splitArea", "splitLine", "minorSplitLine"],
    aw = (function (t) {
      function e() {
        var n = (null !== t && t.apply(this, arguments)) || this;
        return (
          ...
          if (
                ...
                I(
                  {
                    handleAutoShown: function (t) {
                      for (
                        ...
                        if (lv(n[i].getOtherAxis(e.axis).scale)) return !0;
                      return !1;
                    },
                  },
                  s,
            ...
            R(rw, l.add, l),
              ...
              R(
                ow,
                function (t) {
                  e.get([t, "show"]) && sw[t](this, this._axisGroup, e, a);
                },
                this,
              ),
                  ...
                  if (t && e) {
                    ...
                    e.traverse(function (t) {
                      if (Pu(t) && t.anid) {
                        ...
                        if (e) {
                          var i = o(t);
                          t.attr(o(e)), du(t, i, n, ss(t).dataIndex);
                        }
                      }
                    });
                  }
      ...
      splitLine: function (t, e, n, i) {
        ...
        if (!r.scale.isBlank()) {
          ...
          for (
            ...
            Lu(_.shape, d.lineWidth), e.add(_);
          }
        }
      },
        ...
        if (l.length)
          for (
            ...
            for (var f = 0; f < l[p].length; f++) {
              ...
              Lu(g.shape, c.lineWidth), e.add(g);
            }
      },
    ...
    cw = { offset: 0 };
  var pw = { label: { enabled: !0 }, decal: { show: !1 } },
    fw = qr(),
    dw = {};
  function gw(t, e) {
      ...
      C(i.label, t.getLocaleModel().get("aria"), !1),
        ...
        (function () {
          if (n.getModel("decal").get("show")) {
            ...
            t.eachSeries(function (t) {
              if (!t.isColorBySeries()) {
                var n = e.get(t.type);
                n || ((n = {}), e.set(t.type, n)), (fw(t).scope = n);
              }
            }),
                ...
                if (!t.isSeriesFiltered(e))
                  if (W(e.enableAriaDecal)) e.enableAriaDecal();
                    ...
                    if (e.isColorBySeries()) {
                      var i = Rc(e.ecModel, e.name, dw, t.getSeriesCount()),
                        r = n.getVisual("decal");
        ...
        (function () {
          var i = t.getLocaleModel().get("aria"),
            o = n.getModel("label");
          if (((o.option = D(o.option, i)), !o.get("enabled"))) return;
          var a = e.getZr().dom;
          ...
          if (p) {
            var f = o.get(["general", "withTitle"]);
            s = r(f, { title: p });
          } else s = o.get(["general", "withoutTitle"]);
          var d = [],
            g =
              l > 1
          ...
          var y = o.getModel(["series", "multiple", "separator"]),
            v = y.get("middle"),
            m = y.get("end");
          (s += d.join(v) + m), a.setAttribute("aria-label", s);
        })();
    }
    function r(t, e) {
      if (!G(t)) return t;
      ...
      return (
        ...
        (e.prototype.init = function (e, n, i) {
          t.prototype.init.call(this, e, n, i),
            (this._sourceManager = new hf(this)),
            cf(this);
        }),
        (e.prototype.mergeOption = function (e, n) {
          t.prototype.mergeOption.call(this, e, n), cf(this);
        }),
        ...
        (e.type = "dataset"),
        (e.defaultOption = { seriesLayoutBy: yc }),
        e
      );
    })(oc),
    mw = (function (t) {
  ...
  by([
    function (t) {
      t.registerPainter("canvas", t_);
    },
  ]),
    by([
      function (t) {
        t.registerChartView(O_),
          t.registerSeriesModel(e_),
          t.registerLayout(
            (function (t, e) {
              return {
                seriesType: t,
      ...
      function (t) {
        t.registerChartView(X_),
          t.registerSeriesModel(B_),
          t.registerLayout(t.PRIORITY.VISUAL.LAYOUT, V(Cv, "bar")),
          t.registerLayout(
                ...
                reset: function (t) {
                  if (Iv(t)) {
                    var e = t.getData(),
                      ...
                      h = ev(e, l) && !!e.getCalculationInfo("stackedOnSeries"),
                      c = r.isHorizontal(),
                      p = (function (t, e) {
          ...
          t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, E_("bar")),
          t.registerAction(
            {
              type: "changeAxisOrder",
      ...
      function (t) {
        t.registerChartView(_x),
          t.registerSeriesModel(Sx),
          (function (t, e) {
            function n(e, n) {
              var i = [];
              return (
            ...
            R(
              ...
              function (t) {
                e(t[0], function (e, i, r) {
                  (e = I({}, e)),
                    r.dispatchAction(
                      I(e, { type: t[1], seriesIndex: n(i, e) }),
                    );
                });
              },
            );
          })("pie", t.registerAction),
          t.registerLayout(V(cx, "pie")),
          t.registerProcessor(
            (function (t) {
              return {
                seriesType: t,
    ...
    by([
      function (t) {
        t.registerComponentView(hw),
          t.registerComponentModel(Mx),
          t.registerCoordinateSystem("cartesian2d", Wx),
          Lx(t, "x", Tx, cw),
          Lx(t, "y", Tx, cw),
          t.registerComponentView(lw),
          t.registerComponentView(uw),
          t.registerPreprocessor(function (t) {
            t.xAxis && t.yAxis && !t.grid && (t.grid = {});
          });
      },
      function (t) {
        t.registerPreprocessor(yw),
          t.registerVisual(t.PRIORITY.VISUAL.ARIA, gw);
      },
      function (t) {
        t.registerComponentModel(vw), t.registerComponentView(mw);
      },
    ]),
    (t.Axis = Rm),
    (t.ChartView = Af),
    ...
    (t.dataTool = {}),
    (t.dependencies = { zrender: "5.4.1" }),
    (t.disConnect = ny),
    (t.disconnect = iy),
    (t.dispose = function (t) {
      G(t) ? (t = $g[t]) : t instanceof Vg || (t = ry(t)),
        t instanceof Vg && !t.isDisposed() && t.dispose();
    }),
    (t.env = r),
    (t.extendChartView = function (t) {
      var e = Af.extend(t);
      return Af.registerClass(e), e;
    }),
    ...
    (t.extendComponentView = function (t) {
      var e = Cf.extend(t);
      return Cf.registerClass(e), e;
    }),
    (t.extendSeriesModel = function (t) {
      var e = mf.extend(t);
      return mf.registerClass(e), e;
    }),
    (t.format = bm),
    ...
    (t.init = function (t, e, n) {
      ...
      return (
        ...
        i && Jr(t, ey, o.id),
        Ng(o),
        ug.trigger("afterinit", o),
        o
      );
    }),
    (t.innerDrawElementOnCanvas = tg),
    (t.matrix = ge),
    (t.number = _m),
    (t.parseGeoJSON = mm),
    (t.parseGeoJson = mm),
    (t.registerAction = cy),
    (t.registerCoordinateSystem = py),
    (t.registerLayout = fy),
    (t.registerLoading = vy),
    (t.registerLocale = fh),
    (t.registerMap = my),
    (t.registerPostInit = ly),
    (t.registerPostUpdate = uy),
    (t.registerPreprocessor = ay),
    (t.registerProcessor = sy),
    (t.registerTheme = oy),
    (t.registerTransform = _y),
    (t.registerUpdateLifecycle = hy),
    (t.registerVisual = dy),
